 ...
 *
 * <ul>
 *   <li>{@link akka.javasdk.keyvalueentity.KeyValueEntity} - The base class for implementing Key
 *       Value Entities
 *   <li>{@link akka.javasdk.keyvalueentity.CommandContext} - Context available during command
 *       processing
 *   <li>{@link akka.javasdk.keyvalueentity.KeyValueEntityContext} - Context available during entity
 *       construction
 * </ul>
 *
