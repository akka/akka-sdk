 ...
 * Entity. To enable this feature you must add {@code @EnableReplicationFilter} annotation to the
 * {@code KeyValueEntity} class, and use the {@code updateReplicationFilter} in the entity effects.
 *
 * <p>State is by default replicated to all regions that have been enabled for the service. For
