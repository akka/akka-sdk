 ...
 *
 * <p>Provides access to session information and tracing capabilities for agents. The context is
 ...
 *
 * <p><strong>Tracing:</strong> Custom tracing can be added for observability and debugging
 * purposes.
 */
public interface AgentContext extends MetadataContext {
   ...
   *
   * <p>The agent participates in a session, which is used for the agent's contextual memory.
   ...
   *
   * <p>Use this to add custom spans and trace information for observability and debugging of agent
   * interactions.
   *
