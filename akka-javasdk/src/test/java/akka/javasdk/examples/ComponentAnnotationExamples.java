...
public class ComponentAnnotationExamples {
  ...
  /**
   * Example using the new Component annotation with all fields.
  ...
  /**
   * Example using the legacy ComponentId annotation.
   * This continues to work for backward compatibility.
   */
