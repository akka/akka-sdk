...
class AgentDefinitionSpec extends AnyWordSpec with Matchers {
  ...
  "AgentDefinition" should {
    ...
    "set goal" in {
      val d = impl(AgentDefinitionImpl.empty().goal("Do something"))

      d.goal shouldBe "Do something"
    }
