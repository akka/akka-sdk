...
- [(Deprecated) Prometheus metrics reference](deprecated-metrics.html)

<!-- </nav> -->

# (Deprecated) Prometheus metrics reference

|  | These Prometheus-style metrics are deprecated and will be removed in a future release. They are retained here for reference only. New deployments should use the OpenTelemetry-based metrics documented in the [metrics reference](metrics.html). |
...
<!-- <footer> -->
<!-- <nav> -->
[Metrics reference](metrics.html) [Tracing reference](tracing.html)
<!-- </nav> -->
