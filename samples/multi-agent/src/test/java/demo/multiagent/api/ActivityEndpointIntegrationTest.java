...
public class ActivityEndpointIntegrationTest extends TestKitSupport {
  ...
  public void shouldHandleFullActivitySuggestionWorkflowWithPreferenceUpdate() {
    ...
    var suggestResponse = httpClient.POST("/activities/" + userId)
    ...
    var locationHeader = suggestResponse.httpResponse().getHeader("Location").orElseThrow().value();
    ...
    Awaitility.await()
        ...
        .untilAsserted(() -> {
          var answerResponse = httpClient.GET("/activities/" + userId + "/" + sessionId)
    ...
    Awaitility.await()
        ...
        .untilAsserted(() -> {
          var listResponse = httpClient.GET("/activities/" + userId)
