...
public class CustomerIntegrationTest extends CustomerRegistryIntegrationTest {
  ...
  public void create() {
    ...
    Awaitility
      ...
      .untilAsserted(() -> {
        StrictResponse<ByteString> res = httpClient
          .POST("/customer/" + id)
  ...
  private void waitForUpstreamServiceStart() {
    ...
    try {
      ...
      throw new RuntimeException(
        "This test requires an external Akka service to be running on localhost:9000 but was not able to reach it.",
        ex
      );
    }
  }
