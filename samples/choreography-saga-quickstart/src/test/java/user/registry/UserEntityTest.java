...
public class UserEntityTest {
  ...
  public void testCreationAndUpdate() {
    ...
    var creationRes = userTestKit.method(UserEntity::createUser).invoke(new UserEntity.Create("John", "Belgium", "john@acme.com"));
    ...
    var updateRes = userTestKit.method(UserEntity::changeEmail).invoke(new UserEntity.ChangeEmail("john.doe@acme.com"));
