...
public class CustomerIntegrationTest extends TestKitSupport {
  ...
  public void create() {
    ...
    Customer customer = new Customer(
      "foo@example.com",
      "Johanna",
      new Address("Some Street", "Somewhere")
    );
  ...
  public void httpCreate() {
    ...
    var response = httpClient.POST("/customer/" + id).withRequestBody(customer).invoke();
  ...
  public void httpChangeName() {
    ...
    createCustomer(
      id,
      new Customer("foo@example.com", "Johanna", new Address("Some Street", "Somewhere"))
    );
  ...
  public void findByCity() {
    Customer johanna = new Customer(
      "johanna@example.com",
      "Johanna",
      new Address("Cool Street", "Nazare")
    );
    Customer joe = new Customer(
      "joe@example.com",
      "Joe",
      new Address("Cool Street", "Lisbon")
    );
    Customer jane = new Customer(
      "jane@example.com",
      "Jane",
      new Address("Cool Street", "Faro")
    );
    ...
    Awaitility.await()
      ...
      .untilAsserted(() -> {
        CustomerList response = componentClient
          .forView()
  ...
  public void findByName() throws Exception {
    ...
    createCustomer(
      id,
      new Customer("foo@example.com", "Foo", new Address("Some Street", "Somewhere"))
    );
  ...
  public void findByEmail() throws Exception {
    ...
    createCustomer(
      id,
      new Customer("bar@example.com", "Bar", new Address("Some Street", "Somewhere"))
    );
    ...
    Awaitility.await()
      ...
      .atMost(20, TimeUnit.SECONDS)
      .untilAsserted(() -> {
        var foundCustomers = componentClient
          .forView()
