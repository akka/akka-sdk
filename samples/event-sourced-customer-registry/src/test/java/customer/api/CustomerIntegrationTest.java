...
public class CustomerIntegrationTest extends TestKitSupport {
  ...
  public void create() {
    ...
    var createCustomerRequest = new CustomerEndpoint.CreateCustomerRequest(
      "foo@example.com",
      "Johanna",
      new Address("Regent Street", "London")
    );
  ...
  public void getUser() {
    ...
    var response = httpClient.GET("/customer/" + id).responseBodyAs(Customer.class).invoke();
  ...
  public void getNonexistantUser() {
    ...
    Assertions.assertThrows(
      ...
      () -> httpClient.GET("/customer/" + id).responseBodyAs(Customer.class).invoke()
    );
  }
  ...
  public void findByName() {
    ...
    createCustomer(
      id,
      new Customer("foo@example.com", "Foo", new Address("Regent Street", "London"))
    );
    ...
    Awaitility
      ...
      .untilAsserted(() -> {
        var customerName = componentClient
          .forView()
  ...
  private void createCustomer(String id, Customer customer) {
    componentClient.forEventSourcedEntity(id).method(CustomerEntity::create).invoke(customer);
  }
