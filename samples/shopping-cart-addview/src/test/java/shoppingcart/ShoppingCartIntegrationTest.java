...
import shoppingcart.domain.ShoppingCartState.LineItem;
...
public class ShoppingCartIntegrationTest extends TestKitSupport {
    ...
    public void createAndManageCart() {
        ...
        var item1 = new LineItem("tv", "Super TV 55'", 1, "A large television");
        var response1 = await(
                componentClient
        ...
        var item2 = new LineItem("tv-table", "Table for TV", 1, "A table perfectly sized to hold a TV");
        var response2 = await(
                componentClient
                        .forEventSourcedEntity(cartId)
                        .method(ShoppingCartEntity::addItem)
