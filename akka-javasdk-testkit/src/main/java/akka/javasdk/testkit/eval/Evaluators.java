...
/**
 * The names the built-in evaluators report under. Stable, because a {@link Gate} names one to hold
 * it to a rate, and a failed run prints them.
 *
 * <p>Each is activated by the matching declaration on {@link Expectations}, except {@link #TARGET}
 * and {@link #SETUP}, which the runner reports when a case never got as far as being evaluated.
 */
public final class Evaluators {
  ...
  /** The target threw instead of answering. */
  public static final String TARGET = "target";

  /** The case's setup threw, so the turn was never taken. */
