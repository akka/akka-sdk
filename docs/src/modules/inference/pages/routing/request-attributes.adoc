...
----
{cli-optimize} rulesets apply commit-routing -f ruleset.json
----
...
[source, shell, subs="attributes+"]
----
{cli-optimize} rulesets apply commit-routing -f ruleset.json --if-revision 3
----
...
[source, shell, subs="attributes+"]
----
{cli-optimize} rulesets get commit-routing
----
...
[source, shell, subs="attributes+"]
----
{cli-optimize} rulesets test commit-routing -f request.json
----
...
[source, shell, subs="attributes+"]
----
{cli-optimize} rulesets rules apply commit-routing commit-message -f rule.json
----
...
[source, shell, subs="attributes+"]
----
{cli-optimize} rulesets rules delete commit-routing commit-message
----
...
[source, shell, subs="attributes+"]
----
{cli-optimize} rulesets priority commit-routing --set 10
----

[source, shell, subs="attributes+"]
----
{cli-optimize} rulesets priority commit-routing
----
...
[source, shell, subs="attributes+"]
----
{cli-optimize} rulesets history commit-routing
----
...
[source, shell, subs="attributes+"]
----
{cli-optimize} rulesets delete commit-routing
----
...
[source, shell, subs="attributes+"]
----
{cli-optimize} routing-classifiers apply commit-router-v4 -f classifier.json
----
...
[source, shell, subs="attributes+"]
----
{cli-optimize} routing-classifiers delete commit-router-v4
----
...
* xref:reference:cli/inference/akka-optimize.adoc#rulesets[`akka optimize rulesets` command reference]
