...
standard   l4       Dedicated   1               23034Mi        1        0           True
----

`CAN PLACE` is the column that answers whether another model will fit. `READY` only says the accelerator itself is healthy.
...
* xref:reference:cli/inference/akka-models.adoc#accelerators[`akka models accelerators` command reference]
