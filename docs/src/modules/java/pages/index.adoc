...
Follow xref:getting-started:author-your-first-service.adoc[] to implement your first service. If you prefer to first explore working example code, you can check out xref:getting-started:build-and-deploy-shopping-cart.adoc[] or our other xref:getting-started:samples.adoc[samples].
