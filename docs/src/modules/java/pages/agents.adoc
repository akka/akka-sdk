...
[source,java]
----
include::example$doc-snippets/src/main/java/com/example/application/ActivityAgentMore.java[tag=onFailure-only]
----
...
----
include::example$multi-agent/src/main/java/demo/multiagent/application/SelectorAgent.java[tag=all]
----
...
----
include::example$multi-agent/src/main/java/demo/multiagent/application/PlannerAgent.java[tag=all]
----
