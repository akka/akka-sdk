...
. Clone the full source code of the Shopping Cart (with View) sample from link:https://github.com/akka-samples/shopping-cart-with-view-quickstart[Github].
...
Now that we've improved the separation of concerns/layers with the various data types being used in the application, we can create the `View`. A view can contain multiple tables, and each one of those tables can be thought of as roughtly equivalent to a table in a traditional RDBMS, except you don't have to worry about where or how that data is stored.
...
----
include::example$shopping-cart-with-view-quickstart/src/main/java/shoppingcart/application/ShoppingCartView.java[tag=view]
----
...
[source,java,indent=0]
.{sample-base-url}/shopping-cart-with-view-quickstart/src/main/java/shoppingcart/application/UserEntity.java[UserEntity.java]
----
include::example$shopping-cart-with-view-quickstart/src/main/java/shoppingcart/application/UserEntity.java[tag=entity]
----
...
[source,java,indent=0]
.{sample-base-url}/shopping-cart-with-view-quickstart/src/main/java/shoppingcart/application/CartCloser.java[CartCloser.java]
----
include::example$shopping-cart-with-view-quickstart/src/main/java/shoppingcart/application/CartCloser.java[tag=consumer]
----
