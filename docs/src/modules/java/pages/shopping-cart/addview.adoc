...
.{sample-base-url}/shopping-cart-with-view-quickstart/src/main/java/shoppingcart/domain/ShoppingCart.java[ShoppingCart.java]
----
include::example$shopping-cart-with-view-quickstart/src/main/java/shoppingcart/domain/ShoppingCart.java[tags=newpubapi]
----
