...
. Clone the full source code of the Shopping Cart (with View) sample from link:https://github.com/akka-samples/shopping-cart-addview[Github].
...
.{sample-base-url}/shopping-cart-addview/src/main/java/shoppingcart/api/ShoppingCartEndpoint.java[ShoppingCartEndpoint.java]
----
include::example$shopping-cart-addview/src/main/java/shoppingcart/api/ShoppingCartEndpoint.java[tags=newpubapi]
----
...
[source,java,indent=0]
.{sample-base-url}/shopping-cart-addview/src/main/java/shoppingcart/application/ShoppingCartEntity.java[ShoppingCartEntity.java]
----
include::example$shopping-cart-addview/src/main/java/shoppingcart/application/ShoppingCartEntity.java[tags=newentityapi]
----
...
[source,java,indent=0]
.{sample-base-url}/shopping-cart-addview/src/main/java/shoppingcart/domain/ShoppingCartState.java[ShoppingCartState.java]
----
include::example$shopping-cart-addview/src/main/java/shoppingcart/domain/ShoppingCartState.java[tags=domain]
----
...
[source,java,indent=0]
.{sample-base-url}/shopping-cart-addview/src/main/java/shoppingcart/application/ShoppingCartView.java[ShoppingCartView.java]
----
include::example$shopping-cart-addview/src/main/java/shoppingcart/application/ShoppingCartView.java[tag=view]
----
...
The user entity in this sample is quite small (but easily enhanced later). It maintains a `currentCartId` on behalf of a user and whenever a cart is "closed" (as a result of a checkout), we generate a new UUID.

[source,java,indent=0]
.{sample-base-url}/shopping-cart-addview/src/main/java/shoppingcart/application/UserEntity.java[UserEntity.java]
----
include::example$shopping-cart-addview/src/main/java/shoppingcart/application/UserEntity.java[tag=entity]
----

=== Adding a cart consumer
Given the preceding entity, we still need _something_ to call the `closeCart` function. Since we want to close carts and generate new UUIDs whenever a cart is checked out, we'll create a consumer that receives `ShoppingCartEvent` events and calls the appropriate user entity method.

[source,java,indent=0]
.{sample-base-url}/shopping-cart-addview/src/main/java/shoppingcart/application/CartCloser.java[CartCloser.java]
----
include::example$shopping-cart-addview/src/main/java/shoppingcart/application/CartCloser.java[tag=consumer]
----

An important point to notice here is that it's the consumer that is generating the random UUID. We don't want the entity to do that during command handling because then its command handlers would no longer be deterministic and testable.
...
.{sample-base-url}/shopping-cart-addview/src/main/java/shoppingcart/api/ShoppingCartEndpoint.java[ShoppingCartEndpoint.java]
----
include::example$shopping-cart-addview/src/main/java/shoppingcart/api/ShoppingCartEndpoint.java[tag=top]
----
...
.{sample-base-url}/shopping-cart-addview/src/main/java/shoppingcart/api/ShoppingCartEndpoint.java[ShoppingCartEndpoint.java]
----
include::example$shopping-cart-addview/src/main/java/shoppingcart/api/ShoppingCartEndpoint.java[tag=get]
----
...
.{sample-base-url}/shopping-cart-addview/src/main/java/shoppingcart/api/ShoppingCartEndpoint.java[ShoppingCartEndpoint.java]
----
include::example$shopping-cart-addview/src/main/java/shoppingcart/api/ShoppingCartEndpoint.java[tag=getmy]
----
