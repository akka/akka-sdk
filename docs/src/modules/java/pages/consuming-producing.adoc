...
- Consume events emitted by an Event Sourced Entity within the same service or from a different service using service to service eventing
- Consume state changes emitted by a Key Value Entity within the same service or from a different service using service to service eventing
- Consume state changes emitted by a Workflow within the same service or from a different service using service to service eventing
