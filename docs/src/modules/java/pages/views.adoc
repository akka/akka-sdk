...
<2> Composes the `ce-subject` attribute from the entity's event subject to include in the view row.
<3> Returns a producing effect with the updated table row state.
