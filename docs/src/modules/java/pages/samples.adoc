...
| Akka Chess: a complete, resilient, automatically scalable, event-sourced chess game | link:https://github.com/akka-samples/akka-chess[Github Repository] |Advanced
|=======================
