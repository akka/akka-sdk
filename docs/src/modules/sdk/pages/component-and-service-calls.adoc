...
This sample implements a gRPC endpoint that delegates a call to a xref:grpc-endpoints.adoc[gRPC endpoint] of a customer registry service, deployed with the service name `customer-registry`.
