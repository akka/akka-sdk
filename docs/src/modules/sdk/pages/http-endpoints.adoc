...
For additional metadata options and configuration, see the link:https://github.com/osodevops/akka-openapi-maven-plugin[Akka OpenAPI Maven plugin documentation].
