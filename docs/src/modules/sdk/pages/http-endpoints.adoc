...
The third party link:https://github.com/osodevops/akka-openapi-maven-plugin[Akka OpenAPI Maven plugin] makes it possible to automatically generate OpenAPI specification for all the endpoints of a service.
...
For more details around additional specification metadata options and configuration, see the link:https://github.com/osodevops/akka-openapi-maven-plugin[Akka OpenAPI Maven plugin documentation].
