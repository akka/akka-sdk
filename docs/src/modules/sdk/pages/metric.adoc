...
[source,java,indent=0]
.{sample-base-url}/src/main/java/com/example/api/ShoppingCartEndpoint.java[ShoppingCartEndpoint.java]
----
...
[source,java,indent=0]
.{sample-base-url}/src/main/java/com/example/Bootstrap.java[Bootstrap.java]
----
