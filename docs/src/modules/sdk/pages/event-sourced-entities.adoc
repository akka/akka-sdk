...
The following sections walk through these steps using a shopping cart service as an example (working sample can be downloaded from link:{sample-base-url}/shopping-cart-quickstart[GitHub, window="new"]).
