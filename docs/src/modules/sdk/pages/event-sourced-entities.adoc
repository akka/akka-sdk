...
* set a time-to-live for automatic deletion of the entity
...
As an alternative to explicit deletion, you can set a time-to-live on a persist effect using `expireAfter`. The entity will be automatically deleted once the given duration has elapsed since the last event was persisted, if no further events have been persisted.
