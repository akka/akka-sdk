...
----
<1> It's a workflow, with reliable and durable execution. Some steps use the xref:sdk:agents/streaming.adoc#_streaming_from_the_workflow[notification system] to inform subscribers about the progress.
...
You find the full source code for this multi-agent sample in the link:https://github.com/akka-samples/multi-agent[akka-samples/multi-agent GitHub Repository, window="new"].
