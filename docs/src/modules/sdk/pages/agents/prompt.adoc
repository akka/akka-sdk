...
[source,java,indent=0]
.{sample-base-url}/doc-snippets/src/main/java/com/example/application/CustomImageLoadingAgent.java[MyImageLoader.java]
----
include::example$doc-snippets/src/main/java/com/example/application/CustomImageLoadingAgent.java[tag=custom-image-loader]
----
