...
With its few, concise components, the Akka SDK is easy to learn. You can develop services in quick, iterative steps by running your code locally with full insight through Akka's console. Or even better, you can use xref:spec-driven-development.adoc[Spec-driven development] to turn natural-language specifications into code.
...
Create your first Akka agent with your AI assistant using Spec-driven development following our instructions to xref:getting-started:spec-your-first-agent.adoc[].

For manually coding your first Akka agent, follow xref:getting-started:author-your-first-service.adoc[] to implement your first agentic service. If you prefer to first explore working example code, you can check out xref:getting-started:shopping-cart/build-and-deploy-shopping-cart.adoc[] or our other xref:getting-started:samples.adoc[samples].
