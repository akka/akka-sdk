...
Decide the component mapping before writing code. Each section gives the default choice, the signals that should change it, and the signs that you chose wrong. The decision helpers carry stable identifiers (CS1 to CS11) so that plans, reviews, and checklists can reference them.
...
[#cs1-entity-type]
=== CS1. Key Value Entity or Event Sourced Entity
...
[#cs2-view-or-entity-read]
=== CS2. View, or query the entity directly
...
[#cs3-workflow-or-choreography]
=== CS3. Workflow orchestration or Consumer choreography

Both implement long-running business processes across components and services. The xref:sdk:dev-best-practices.adoc#saga-patterns[saga patterns] section describes the two shapes.
...
[#cs4-consumer-or-direct-call]
=== CS4. Consumer, or a direct call
...
[#cs5-timed-action-or-workflow-timer]
=== CS5. Timed Action or Workflow timer
...
[#cs6-agent-kind]
=== CS6. Agent, Autonomous Agent, or a Workflow around agents
...
[#cs9-in-process-or-network]
=== CS9. In-process or over-the-network
...
[#cs10-component-or-plain-class]
=== CS10. Not everything is a component
...
[#cs11-third-party-calls]
=== CS11. Calling third-party services
