...
| xref:reference:specify/docs.adoc[`/akka:docs`] | Generate rendered project documentation -- a component reference plus entity and interaction diagrams -- into the `docs/` folder.
|===
