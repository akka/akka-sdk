...
[sidebar]
****
Another convenient way is to use the Akka CLI. See xref:getting-started:quick-install-cli.adoc[installation instructions]. It will download the markdown documentation.
...
For https://www.anthropic.com/claude-code[Claude code] you need to define a `CLAUDE.md` file with instructions.

* Download link:../_attachments/CLAUDE.md[CLAUDE.md] to `CLAUDE.md` file in the project directory.
* Download link:../_attachments/AGENTS.md[AGENTS.md] to `AGENTS.md` file in the project directory.

Note that `CLAUDE.md` includes the detailed instructions from `AGENTS.md`. The reason for the separation into two files is that you should be able to download updated versions of `AGENTS.md` and have your custom instructions in `CLAUDE.md`.
...
The coding assistant will generate more accurate code if we give it some detailed instructions. We have prepared such xref:sdk:ai-coding-assistant-guidelines.adoc[guidelines] that you can use as a template.
