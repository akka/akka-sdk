...
You can find the full source code of workflow notification sample in the link:{sample-base-url}/multi-agent[akka-samples/multi-agent GitHub Repository, window="new"].
