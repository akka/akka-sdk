...
You can find the full source code of workflow notification sample in the link:https://github.com/akka-samples/multi-agent[akka-samples/multi-agent GitHub Repository].
