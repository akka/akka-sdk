...
For models that support thinking, enabling it is done in a model specific way, for some models a thinking token budget is assigned, for
some it is a on/off toggle. All models supporting thinking has it disabled by default.
