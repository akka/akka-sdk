...
| Boolean
| Enable prompt caching of the last system message. Disabled by default. See https://docs.anthropic.com/en/docs/build-with-claude/prompt-caching[Anthropic prompt caching] for details.
...
| prompt-caching
| String
| Enable prompt caching for Anthropic Claude or Amazon Nova models by selecting where the cache point is placed. Valid values: `""` (disabled, default), `"after-system"`, `"after-user-message"`, `"after-tools"`. See https://docs.aws.amazon.com/bedrock/latest/userguide/prompt-caching.html[AWS Bedrock prompt caching] for details.
