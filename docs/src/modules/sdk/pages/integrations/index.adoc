...
* xref:sdk:rag.adoc[Retrieval-Augmented Generation (RAG)] — semantic search on vector databases to enrich AI model requests
...
* xref:sdk:message-brokers.adoc[Message brokers] — Kafka, Google Pub/Sub, Azure Event Hubs
