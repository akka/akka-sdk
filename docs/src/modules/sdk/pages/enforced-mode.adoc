...
Author-time is a precondition, not a ship target. Every ship, review or release, requires every applicable author-tier condition to be green or waiver-covered. See xref:reference:specify/exit-condition-states.adoc#ship-tiers[Ship tiers].
