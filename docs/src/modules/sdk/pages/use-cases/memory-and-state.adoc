...
* link:{sample-base-url}/travel-agent[travel-planning-agent,window="new"] -- session memory for multi-turn travel planning conversations
* link:{sample-base-url}/shopping-cart-quickstart[shopping-cart-quickstart,window="new"] -- event sourced shopping cart with views
* link:{sample-base-url}/event-sourced-customer-registry[event-sourced-customer-registry,window="new"] -- event sourced entity pattern for customer data
