...
* https://github.com/akka-samples/travel-agent[travel-planning-agent] -- session memory for multi-turn travel planning conversations
* https://github.com/akka-samples/shopping-cart-quickstart[shopping-cart-quickstart] -- event sourced shopping cart with views
...
* https://github.com/akka-samples/event-sourced-customer-registry[event-sourced-customer-registry] -- event sourced entity pattern for customer data
