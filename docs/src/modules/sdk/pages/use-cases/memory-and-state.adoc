...
* https://github.com/akka/akka-sdk/blob/main/samples/travel-planning-agent[travel-planning-agent] -- session memory for multi-turn travel planning conversations
* https://github.com/akka/akka-sdk/blob/main/samples/shopping-cart-quickstart[shopping-cart-quickstart] -- event sourced shopping cart with views
* https://github.com/akka/akka-sdk/blob/main/samples/key-value-customer-registry[key-value-customer-registry] -- key-value entity pattern for customer data
* https://github.com/akka/akka-sdk/blob/main/samples/event-sourced-customer-registry[event-sourced-customer-registry] -- event sourced entity pattern for customer data
