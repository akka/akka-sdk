...
* {sample-base-url}/travel-planning-agent[travel-planning-agent] -- session memory for multi-turn travel planning conversations
* {sample-base-url}/shopping-cart-quickstart[shopping-cart-quickstart] -- event sourced shopping cart with views
* {sample-base-url}/key-value-customer-registry[key-value-customer-registry] -- key-value entity pattern for customer data
* {sample-base-url}/event-sourced-customer-registry[event-sourced-customer-registry] -- event sourced entity pattern for customer data
