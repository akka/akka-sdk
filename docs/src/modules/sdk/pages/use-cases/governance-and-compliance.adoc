...
* link:{sample-base-url}/medical-discharge-tagging[medical-discharge-tagging] -- human verification workflow for AI-generated medical classifications
* link:{sample-base-url}/transfer-workflow-compensation[transfer-workflow-compensation] -- compensation logic demonstrating rollback and recovery controls
* link:{sample-base-url}/tracing[tracing] -- observability and tracing for audit trail and compliance reporting
