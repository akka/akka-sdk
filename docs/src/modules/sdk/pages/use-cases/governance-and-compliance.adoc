...
* link:{sample-base-url}/medical-tagging-agent[medical-discharge-tagging,window="new"] -- human verification workflow for AI-generated medical classifications
* link:{sample-base-url}/transfer-workflow-compensation[transfer-workflow-compensation,window="new"] -- compensation logic demonstrating rollback and recovery controls
