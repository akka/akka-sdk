...
* https://github.com/akka-samples/medical-tagging-agent[medical-discharge-tagging] -- human verification workflow for AI-generated medical classifications
* https://github.com/akka-samples/transfer-workflow-compensation[transfer-workflow-compensation] -- compensation logic demonstrating rollback and recovery controls
