...
* https://github.com/akka/akka-sdk/blob/main/samples/medical-discharge-tagging[medical-discharge-tagging] -- human verification workflow for AI-generated medical classifications
* https://github.com/akka/akka-sdk/blob/main/samples/transfer-workflow-compensation[transfer-workflow-compensation] -- compensation logic demonstrating rollback and recovery controls
* https://github.com/akka/akka-sdk/blob/main/samples/tracing[tracing] -- observability and tracing for audit trail and compliance reporting
