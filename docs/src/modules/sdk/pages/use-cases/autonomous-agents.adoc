...
* https://github.com/akka-samples/changelog-agent[release-note-summarizer] -- agent that autonomously summarizes release notes from upstream sources
* https://github.com/akka-samples/medical-tagging-agent[medical-discharge-tagging] -- agent that classifies and tags medical discharge records
* https://github.com/akka-samples/temperature-monitoring-agent[temperature-monitoring] -- agent that monitors IoT sensor data and triggers alerts
