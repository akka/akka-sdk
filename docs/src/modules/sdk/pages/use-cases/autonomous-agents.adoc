...
* link:{sample-base-url}/release-note-summarizer[release-note-summarizer] -- agent that autonomously summarizes release notes from upstream sources
* link:{sample-base-url}/medical-discharge-tagging[medical-discharge-tagging] -- agent that classifies and tags medical discharge records
* link:{sample-base-url}/iot-sensor-monitoring[iot-sensor-monitoring] -- agent that monitors IoT sensor data and triggers alerts
