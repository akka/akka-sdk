...
* link:{sample-base-url}/transfer-workflow[transfer-workflow] -- basic multi-step transfer workflow
* link:{sample-base-url}/transfer-workflow-orchestration[transfer-workflow-orchestration] -- orchestration-based saga for fund transfers
* link:{sample-base-url}/transfer-workflow-compensation[transfer-workflow-compensation] -- transfer workflow with compensation logic for failure recovery
* link:{sample-base-url}/choreography-saga-quickstart[choreography-saga-quickstart] -- choreography-based saga pattern for distributed coordination
* link:{sample-base-url}/reliable-timers[reliable-timers] -- durable timers that survive restarts and failures
