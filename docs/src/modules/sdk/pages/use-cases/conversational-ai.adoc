...
* https://github.com/akka/akka-sdk/blob/main/samples/helloworld-agent[helloworld-agent] -- minimal agent showing basic conversational interaction
* https://github.com/akka/akka-sdk/blob/main/samples/customer-service-chat[customer-service-chat] -- full customer service agent with multi-turn memory and tool use
* https://github.com/akka/akka-sdk/blob/main/samples/travel-planning-agent[travel-planning-agent] -- travel planning assistant with session state and external integrations
