...
* https://github.com/akka-samples/helloworld-agent[helloworld-agent] -- minimal agent showing basic conversational interaction
...
* https://github.com/akka-samples/travel-agent[travel-planning-agent] -- travel planning assistant with session state and external integrations
