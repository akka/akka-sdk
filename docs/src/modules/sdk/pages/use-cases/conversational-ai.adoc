...
* link:{sample-base-url}/helloworld-agent[helloworld-agent,window="new"] -- minimal agent showing basic conversational interaction
* link:{sample-base-url}/travel-agent[travel-planning-agent,window="new"] -- travel planning assistant with session state and external integrations
