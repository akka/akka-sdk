...
* https://github.com/akka/akka-sdk/blob/main/samples/shopping-cart-quickstart[shopping-cart-quickstart] -- event sourced shopping cart with views and projections
* https://github.com/akka/akka-sdk/blob/main/samples/choreography-saga-quickstart[choreography-saga-quickstart] -- choreography-based saga for distributed business transactions
* https://github.com/akka/akka-sdk/blob/main/samples/spring-dependency-injection[spring-dependency-injection] -- integrating Akka components with Spring dependency injection
