...
* link:{sample-base-url}/shopping-cart-quickstart[shopping-cart-quickstart,window="new"] -- event sourced shopping cart with views and projections
* link:{sample-base-url}/choreography-saga-quickstart[choreography-saga-quickstart,window="new"] -- choreography-based saga for distributed business transactions
