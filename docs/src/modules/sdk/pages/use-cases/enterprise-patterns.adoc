...
* https://github.com/akka-samples/shopping-cart-quickstart[shopping-cart-quickstart] -- event sourced shopping cart with views and projections
* https://github.com/akka-samples/choreography-saga-quickstart[choreography-saga-quickstart] -- choreography-based saga for distributed business transactions
