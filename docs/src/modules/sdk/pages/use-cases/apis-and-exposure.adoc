...
* https://github.com/akka-samples/endpoint-jwt[endpoint-jwt] -- HTTP endpoint with JWT-based authentication
* https://github.com/akka-samples/trip-agent[trip-booking-with-tools] -- agent exposed via multiple endpoint types with tool integration
