...
* link:{sample-base-url}/endpoint-jwt[endpoint-jwt,window="new"] -- HTTP endpoint with JWT-based authentication
* link:{sample-base-url}/trip-agent[trip-booking-with-tools,window="new"] -- agent exposed via multiple endpoint types with tool integration
