...
* https://github.com/akka/akka-sdk/blob/main/samples/endpoint-jwt[endpoint-jwt] -- HTTP endpoint with JWT-based authentication
* https://github.com/akka/akka-sdk/blob/main/samples/trip-booking-with-tools[trip-booking-with-tools] -- agent exposed via multiple endpoint types with tool integration
