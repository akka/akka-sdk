...
* link:{sample-base-url}/endpoint-jwt[endpoint-jwt] -- HTTP endpoint with JWT-based authentication
* link:{sample-base-url}/trip-booking-with-tools[trip-booking-with-tools] -- agent exposed via multiple endpoint types with tool integration
