...
* link:{sample-base-url}/multi-agent[multi-agent] -- multiple agents coordinating on a shared task with structured handoffs
* link:{sample-base-url}/customer-service-chat[customer-service-chat] -- multi-agent customer service system with routing and specialization
