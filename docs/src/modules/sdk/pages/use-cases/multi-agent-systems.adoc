...
* https://github.com/akka/akka-sdk/blob/main/samples/multi-agent[multi-agent] -- multiple agents coordinating on a shared task with structured handoffs
* https://github.com/akka/akka-sdk/blob/main/samples/customer-service-chat[customer-service-chat] -- multi-agent customer service system with routing and specialization
