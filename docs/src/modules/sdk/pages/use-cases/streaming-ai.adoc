...
* https://github.com/akka/akka-sdk/blob/main/samples/iot-sensor-monitoring[iot-sensor-monitoring] -- real-time AI analysis of IoT sensor data streams
* https://github.com/akka/akka-sdk/blob/main/samples/event-sourced-customer-registry-subscriber[event-sourced-customer-registry-subscriber] -- event-driven consumer that reacts to entity state changes
