...
* link:{sample-base-url}/iot-sensor-monitoring[iot-sensor-monitoring] -- real-time AI analysis of IoT sensor data streams
* link:{sample-base-url}/event-sourced-customer-registry-subscriber[event-sourced-customer-registry-subscriber] -- event-driven consumer that reacts to entity state changes
