...
* link:{sample-base-url}/temperature-monitoring-agent[iot-sensor-monitoring,window="new"] -- real-time AI analysis of IoT sensor data streams
* link:{sample-base-url}/event-sourced-customer-registry[event-sourced-customer-registry-subscriber,window="new"] -- event-driven consumer that reacts to entity state changes
