...
* https://github.com/akka-samples/temperature-monitoring-agent[iot-sensor-monitoring] -- real-time AI analysis of IoT sensor data streams
* https://github.com/akka-samples/event-sourced-customer-registry[event-sourced-customer-registry-subscriber] -- event-driven consumer that reacts to entity state changes
