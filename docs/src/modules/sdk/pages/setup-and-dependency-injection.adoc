...
The `akka.javasdk.Sanitizer` can be injected in all component types, see xref:sdk:sanitization.adoc[].
...
----
include::example$akka-javasdk/src/main/resources/reference.conf[tag=reference]
----
