...
| Deprecated, use `akka.javasdk.SanitizerClient`. Allows for applying sanitization, see xref:sdk:sanitization.adoc[]
...
| `akka.javasdk.SanitizerClient`
| For masking text with a configured sanitizer by name, see xref:sdk:sanitization.adoc[]
|===
