...
1. If you are using Java https://openjdk.org/jeps/395[record, window="new"] then no annotation is needed. It just works. It is as simple as using `record` instead of `class`. Akka leverages https://github.com/FasterXML/[Jackson] under the hood and makes these records serializable for you.
