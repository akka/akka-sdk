...
As an alternative to explicit deletion, you can set a time-to-live on a state update using `expireAfter`. The entity will be automatically deleted once the given duration has elapsed since the write, if no further update has been made.
