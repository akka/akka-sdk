...
*What it does.* SDD provides a structured, iterative workflow -- specify, clarify, plan, task, implement, build, inspect, deploy -- backed by a constitution of unbreakable project rules. Every artifact is version-controlled, and automated CI can detect divergence between specification and code.
