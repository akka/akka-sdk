...
NOTE: Not using Claude Code? Akka supports 30 different AI assist tools. You can also clone the Akka plugin directly from the Akka repository. Visit https://doc.akka.io[doc.akka.io] for installation instructions for your tool.

[TIP.manual]
.Without the plugin
====
If you are unable to install the marketplace plugin or clone the plugin from the repository, fall back to the Akka CLI:
