...
image::sdd-workflow.svg[Spec-driven development workflow: init, specify, clarify, plan, tasks, implement, build, inspect, deploy — with an iteration loop that refines the spec and regenerates.]
