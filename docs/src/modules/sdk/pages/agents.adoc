...
:page-related: xref:concepts:ai-agents.adoc[], xref:sdk:agents/guardrails.adoc[], xref:sdk:agents/memory.adoc[], xref:sdk:workflows.adoc[], xref:sdk:key-value-entities.adoc[]
...
* **Multi-step deterministic orchestration** -- use xref:sdk:workflows.adoc[Workflows] to coordinate steps that do not require LLM reasoning.
...
* **Autonomous Agents** are the model-driven alternative for multi-step work and multi-agent coordination, with built-in task lifecycle and coordination capabilities. See xref:sdk:autonomous-agents.adoc[].
