You would normally not expose Entities, Workflows and Views directly to the outside world, but have an xref:sdk:http-endpoints.adoc[Endpoint] or xref:sdk:consuming-producing.adoc[Consumer] in front of it.
