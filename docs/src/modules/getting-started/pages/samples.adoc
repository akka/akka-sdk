...
link:{sample-base-url}/helloworld-agent[GitHub Repository, window="new"]
...
**Concepts**: _Agent_, _LLM_
**Level**: _Beginner_
link:{sample-base-url}/helloworld-agent-kotlin[GitHub Repository, window="new"]
...
link:{sample-base-url}/multi-agent[GitHub Repository, window="new"]
...
link:{sample-base-url}/ask-akka-agent[GitHub Repository, window="new"]
...
**Level**: _Beginner_
link:{sample-base-url}/travel-agent[GitHub Repository, window="new"]
...
**Level**: _Beginner_
link:{sample-base-url}/agentic-haiku[GitHub Repository, window="new"]
...
**Level**: _Intermediate_
link:{sample-base-url}/medical-tagging-agent[GitHub Repository, window="new"]
...
**Level**: _Intermediate_
link:{sample-base-url}/temperature-monitoring-agent[GitHub Repository, window="new"]
...
**Level**: _Intermediate_
link:{sample-base-url}/changelog-agent[GitHub Repository, window="new"]
...
**Concepts**: _Agent_, _Workflow_, _Multi-agent_, _LLM_
**Level**: _Advanced_
link:{sample-base-url}/adaptive-multi-agent[GitHub Repository, window="new"]
...
**Level**: _Intermediate_
link:{sample-base-url}/real-estate-cs-agent[GitHub Repository, window="new"]
...
link:{sample-base-url}/trip-agent[GitHub Repository, window="new"]
...
**Level**: _Intermediate_
link:{sample-base-url}/healthcare-agent[GitHub Repository, window="new"]
...
link:{sample-base-url}/shopping-cart-quickstart[GitHub Repository, window="new"]
...
**Level**: Intermediate
link:{sample-base-url}/event-sourced-customer-registry[GitHub Repository, window="new"]
...
**Level**: _Intermediate_
link:{sample-base-url}/transfer-workflow-orchestration[GitHub Repository, window="new"]
...
**Level**: _Intermediate_
link:{sample-base-url}/transfer-workflow-compensation[GitHub Repository, window="new"]
...
**Level**: _Advanced_
link:{sample-base-url}/choreography-saga-quickstart[GitHub Repository, window="new"]
...
**Level**: _Advanced_
link:{sample-base-url}/akka-chess[GitHub Repository, window="new"]
