...
xref:getting-started:author-your-first-service.adoc[] to get a minimal "Hello World!" Akka service and run it locally.
====
...
The xref:getting-started:author-your-first-service.adoc[] starts from the Maven archetype and lets you implement a very simple service.
