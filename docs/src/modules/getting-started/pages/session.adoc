= AI RAG Agent Part 1: Modeling the agent session
...
You already learned how to create an empty Akka project when you went through the guide to xref:getting-started:author-your-first-service.adoc#_generate_and_build_the_project[author your agentic first service]. Follow those steps again to ensure that you've got a new project that compiles.
