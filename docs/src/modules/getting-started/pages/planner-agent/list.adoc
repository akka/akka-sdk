...
.ActivityView.java
----
include::sdk:example$doc-snippets/src/main/java/agent_guide/part5/ActivityView.java[tag=all]
----
...
[source,java,indent=0]
----
include::sdk:example$doc-snippets/src/main/java/agent_guide/part5/ActivityEndpoint.java[tag=list]
----
...
* Learn more about the xref:sdk:views.adoc[`View` component].
