...
xref:planner-agent/index.adoc[1: The activity agent] > xref:planner-agent/preferences.adoc[2: User preferences] > xref:planner-agent/weather.adoc[3: Weather agent] > **4: Orchestrate the agents** > xref:planner-agent/list.adoc[5: List by user] > > xref:planner-agent/dynamic-team.adoc[6: Dynamic orchestration]
...
.AgentTeam.java
----
include::java:example$doc-snippets/src/main/java/agent_guide/part4/AgentTeam.java[tag=class]
----
