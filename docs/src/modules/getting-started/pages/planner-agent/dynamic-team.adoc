...
----
include::sdk:example$multi-agent/src/main/java/demo/multiagent/application/SelectorAgent.java[tag=all]
----
...
----
include::sdk:example$multi-agent/src/main/java/demo/multiagent/domain/AgentSelection.java[tag=all]
----
...
----
include::sdk:example$multi-agent/src/main/java/demo/multiagent/application/WeatherAgent.java[tag=description]
----
...
----
include::sdk:example$multi-agent/src/main/java/demo/multiagent/application/ActivityAgent.java[tag=description]
----

Note that in image:concepts:steps-2.svg[width=20] of the `SelectorAgent` we retrieve a subset of the agents with a certain role. This role is also defined in the `@AgentRole` annotation.
...
----
include::sdk:example$multi-agent/src/main/java/demo/multiagent/application/PlannerAgent.java[tag=all]
----
...
----
include::sdk:example$multi-agent/src/main/java/demo/multiagent/domain/Plan.java[tag=all]
----
...
----
include::sdk:example$multi-agent/src/main/java/demo/multiagent/domain/PlanStep.java[tag=all]
----
...
----
include::sdk:example$multi-agent/src/main/java/demo/multiagent/domain/AgentRequest.java[tag=all]
----
...
----
include::sdk:example$multi-agent/src/main/java/demo/multiagent/application/AgentTeamWorkflow.java[tag=all]
----
<1> It's a workflow, with reliable and durable execution and the xref:sdk:agents/streaming.adoc#_streaming_from_the_workflow[notification system].
...
----
include::sdk:example$multi-agent/src/main/java/demo/multiagent/application/SummarizerAgent.java[tag=all]
----
...
image:multi-agent-flowview.png[Flow view for the Multi agent]
...
* A more advanced sample illustrates link:https://github.com/akka-samples/adaptive-multi-agent[adaptive multi-agent orchestration, window="new"]. It re-evaluates progress after each agent response and dynamically adjusts its strategy.
