...
xref:planner-agent/index.adoc[1: The activity agent] > **2: User preferences** > xref:planner-agent/weather.adoc[3: Weather agent] > xref:planner-agent/team.adoc[4: Orchestrate the agents] > xref:planner-agent/list.adoc[5: List by user]
