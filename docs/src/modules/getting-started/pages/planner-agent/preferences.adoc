...
xref:planner-agent/index.adoc[1: The activity agent] > **2: User preferences** > xref:planner-agent/weather.adoc[3: Weather agent]
...
Activities may depend on the weather forecast. Continue with xref:planner-agent/weather.adoc[Part 3: Weather agent]
