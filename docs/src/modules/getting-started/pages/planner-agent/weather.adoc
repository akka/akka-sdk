...
xref:planner-agent/index.adoc[1: The activity agent] > xref:planner-agent/preferences.adoc[2: User preferences] > **Weather agent**
...
Introduce a workflow that orchestrates the calls between the agents.
