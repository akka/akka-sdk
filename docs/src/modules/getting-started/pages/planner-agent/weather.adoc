...
xref:planner-agent/index.adoc[1: The activity agent] > xref:planner-agent/preferences.adoc[2: User preferences] > **Weather agent** > xref:planner-agent/team.adoc[4: Orchestrate the agents]
