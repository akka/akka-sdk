...
----
include::sdk:example$multi-agent/src/main/java/demo/multiagent/application/PreferencesConsumer.java[tag=all]
----
...
----
include::sdk:example$multi-agent/src/main/java/demo/multiagent/application/AgentTeamWorkflow.java[tag=runAgain]
----
