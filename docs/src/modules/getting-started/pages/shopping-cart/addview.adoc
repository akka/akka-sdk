...
. Clone the full source code of the Shopping Cart (with View) sample from link:https://github.com/akka-samples/shopping-cart-with-view[GitHub, window="new"].
...
----
include::sdk:example$shopping-cart-with-view/src/main/java/shoppingcart/api/ShoppingCartEndpoint.java[tags=newpubapi]
----
...
----
include::sdk:example$shopping-cart-with-view/src/main/java/shoppingcart/application/ShoppingCartEntity.java[tags=newentityapi]
----
...
----
include::sdk:example$shopping-cart-with-view/src/main/java/shoppingcart/domain/ShoppingCart.java[tags=domain]
----
...
----
include::sdk:example$shopping-cart-with-view/src/main/java/shoppingcart/application/ShoppingCartView.java[tag=view]
----
...
----
include::sdk:example$shopping-cart-with-view/src/main/java/shoppingcart/application/UserEntity.java[tag=entity]
----
...
----
include::sdk:example$shopping-cart-with-view/src/main/java/shoppingcart/application/CartCloser.java[tag=consumer]
----
...
In the following code, we add support for **xref:sdk:auth-with-jwts.adoc[JWT]**-based bearer tokens to the HTTP endpoint with just a single line. While not shown here, you can define all kinds of rules based on the claims supplied in a token.

[source,java,indent=0]
.{sample-base-url}/shopping-cart-with-view/src/main/java/shoppingcart/api/ShoppingCartEndpoint.java[ShoppingCartEndpoint.java]
----
include::sdk:example$shopping-cart-with-view/src/main/java/shoppingcart/api/ShoppingCartEndpoint.java[tag=top]
----
...
.{sample-base-url}/shopping-cart-with-view/src/main/java/shoppingcart/api/ShoppingCartEndpoint.java[ShoppingCartEndpoint.java]
----
include::sdk:example$shopping-cart-with-view/src/main/java/shoppingcart/api/ShoppingCartEndpoint.java[tag=get]
----
...
.{sample-base-url}/shopping-cart-with-view/src/main/java/shoppingcart/api/ShoppingCartEndpoint.java[ShoppingCartEndpoint.java]
----
include::sdk:example$shopping-cart-with-view/src/main/java/shoppingcart/api/ShoppingCartEndpoint.java[tag=getmy]
----
...
image:shoppingcart_request_builder.png[Shopping cart request builder]
...
image:shoppingcart_request_flow.png[Shopping cart request trace view]
...
. *Expand on your own*: Explore xref:sdk:components/index.adoc[other Akka components] to enhance your application with additional features.
