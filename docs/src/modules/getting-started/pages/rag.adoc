...
In the first part of this guide, it couldn't answer that question meaningfully, but now it will answer something like:
...
Next we'll create xref:endpoints.adoc[UI endpoints].
