...
.HelloWorldEndpoint.java
----
include::java:example$doc-snippets/src/main/java/com/example/api/ExampleEndpoint.java[tag=basic-path-parameters]
----
...
.HelloWorldEndpoint.java
----
include::java:example$doc-snippets/src/main/java/com/example/api/ExampleEndpoint.java[tag=request-body]
----
...
.HelloWorldEndpoint.java
----
include::java:example$doc-snippets/src/main/java/com/example/api/ExampleEndpoint.java[tag=response-body]
----
