...
:page-summary: Hands-on tutorial to build your first Akka agent by hand in Java.
:page-persona: builder-developer

include::ROOT:partial$include.adoc[]

TIP: The recommended way to build your first agent is the xref:getting-started:spec-your-first-agent.adoc[Spec-first hello agent] tutorial. The tutorial below walks through the manual, hands-on Java approach — ideal for understanding how Akka components work under the hood.
...
* Complete xref:getting-started:set-up-dev-env.adoc#_set_up_your_env_without_ai[Set up your env without AI] — install the Akka CLI, Java, and Maven.
* Git.
* An https://platform.openai.com/api-keys[OpenAI API key, window="new"]. This sample uses OpenAI; sign up for free at https://platform.openai.com/api-keys[platform.openai.com/api-keys, window="new"].
