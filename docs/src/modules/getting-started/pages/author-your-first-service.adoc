...
TIP: As alternative without coding in Java, you may use xref:sdk:spec-driven-development.adoc[Spec-Driven Development] to create a version of the xref:getting-started:sdd-hello-agent.adoc[].
...
* See the xref:getting-started:sdd-hello-agent.adoc[Spec-first greeting agent] sample if you use an AI assistant and want to see a xref:sdk:spec-driven-development.adoc[Spec-Driven Development] alternative to this example.
