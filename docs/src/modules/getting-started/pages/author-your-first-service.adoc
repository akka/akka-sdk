...
TIP: As alternative without coding in Java, you may use xref:sdk:spec-driven-development.adoc[Spec-Driven Development] to create a version of the xref:getting-started:spec-your-first-agent.adoc[].
