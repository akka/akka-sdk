...
You now have a running Akka service built entirely from a specification. See xref:sdk:spec-driven-development.adoc[Spec-Driven Development] for the full SDD workflow.
