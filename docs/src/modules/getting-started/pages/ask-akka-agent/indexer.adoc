...
----
include::sdk:example$ask-akka-agent/pom.xml[]
----
...
----
include::sdk:example$ask-akka-agent/src/main/java/akka/ask/indexer/application/RagIndexingWorkflow.java[tag=shell]
----
...
.{sample-base-url}/ask-akka-agent/src/main/java/akka/ask/indexer/application/RagIndexingWorkflow.java[RagIndexingWorkflow.java]
----
include::sdk:example$ask-akka-agent/src/main/java/akka/ask/indexer/application/RagIndexingWorkflow.java[tag=def]
----
...
.{sample-base-url}/ask-akka-agent/src/main/java/akka/ask/indexer/application/RagIndexingWorkflow.java[RagIndexingWorkflow.java]
----
include::sdk:example$ask-akka-agent/src/main/java/akka/ask/indexer/application/RagIndexingWorkflow.java[tag=index]
----
...
.{sample-base-url}/ask-akka-agent/src/main/java/akka/ask/indexer/application/RagIndexingWorkflow.java[RagIndexingWorkflow.java]
----
include::sdk:example$ask-akka-agent/src/main/java/akka/ask/indexer/application/RagIndexingWorkflow.java[tag=add]
----
...
.{sample-base-url}/ask-akka-agent/src/main/java/akka/ask/indexer/application/RagIndexingWorkflow.java[RagIndexingWorkflow.java]
----
include::sdk:example$ask-akka-agent/src/main/java/akka/ask/indexer/application/RagIndexingWorkflow.java[tag=start]
----
...
.{sample-base-url}/ask-akka-agent/src/main/java/akka/ask/indexer/application/RagIndexingWorkflow.java[RagIndexingWorkflow.java]
----
include::sdk:example$ask-akka-agent/src/main/java/akka/ask/indexer/application/RagIndexingWorkflow.java[tag=cons]
----
...
----
include::sdk:example$ask-akka-agent/src/main/java/akka/ask/Bootstrap.java[tag=mongodb]
----
...
----
include::sdk:example$ask-akka-agent/src/main/java/akka/ask/indexer/api/IndexerEndpoint.java[tag=class]
----
