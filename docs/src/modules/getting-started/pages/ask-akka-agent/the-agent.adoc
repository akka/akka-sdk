...
[NOTE]
====
This guide is written assuming you will follow it as a tutorial to walk through all of the components, building them on your own. If at any time you want to compare your solution with the official sample, check out the link:{sample-base-url}/ask-akka-agent[GitHub Repository, window="new"].
====
