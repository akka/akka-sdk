...
TIP: If you're already using an AI coding assistant and want to build your first apps with xref:sdk:spec-your-first-agent.adoc[Spec-Driven Development], then you can use the `akka specify init` command instead.
