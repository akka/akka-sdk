...
TIP: If you're already using an AI coding assistant and want to build your first apps with xref:getting-started:spec-your-first-agent.adoc[Spec-Driven Development], then you can use the `akka specify init` CLI command. If you're using the Akka marketplace Claude Code plugin, then initialization is done for you automatically.
