...
Run `/akka:build`. This recompiles the project, runs the tests, starts the service, and issues a sample request to the endpoint. The AI picks a default port for the service, usually port `9000`.
