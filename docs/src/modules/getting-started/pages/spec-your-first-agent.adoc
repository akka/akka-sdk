...
Run `/akka:ship`. It runs the in-scope auditors one last time, fires the terminal action your organization defined, and writes a xref:sdk:enforced-mode.adoc#shipping[conformance receipt] recording what was verified.
