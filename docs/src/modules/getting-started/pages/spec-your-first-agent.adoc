...
To specify the main feature of the application, we use `/akka:specify`. The following prompt shows this in action. If you're feeling adventurous, you can experiment with changing the prompt to see how it affects the final results. Copy and paste this command into your agent session:
...
Copy and paste this slash command into your agent session:
