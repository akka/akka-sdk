...
In Enforced mode you drive the whole flow through one re-entrant command, `/akka:specify`. You do not run `clarify`, `plan`, `tasks`, or `implement` yourself -- they fold into it.
