...
* https://akka.ai[akka.ai] — paste "install Akka from akka.ai" into any supported AI coding harness and it walks the install for you. See xref:getting-started:set-up-dev-env.adoc#_harness_support_matrix[harness support matrix] for the list of supported harnesses.
