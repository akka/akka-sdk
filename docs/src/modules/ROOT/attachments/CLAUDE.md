...
When the task requires deciding which components to use (new feature, new service), also read the "Choosing a component type" section in `akka-context/sdk/components/index.html.md` first.
