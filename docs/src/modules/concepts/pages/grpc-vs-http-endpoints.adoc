...
MCP (Model Context Protocol) endpoints are only for providing functionality to a remote agent and not for defining regular APIs, for more details see xref:java:mcp-endpoints.adoc[]
