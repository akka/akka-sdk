...
* link:{sample-base-url}/ask-akka-agent[ask-akka-agent, window="new"] - An agentic conversation sample
* link:{sample-base-url}/multi-agent[multi-agent, window="new"] - Our classic multi-agent sample
* link:{sample-base-url}/trip-agent[trip-agent, window="new"] - A trip planning agent
...
=== Examples
The PlannerAgent in xref:getting-started:planner-agent/dynamic-team.adoc[this example] illustrates this pattern.
...
=== Examples
In our xref:getting-started:planner-agent/dynamic-team.adoc[Akka dynamic orchestration] example, we illustrate a planning and evaluation loop, as well as re-planning.

Additionally, the link:{sample-base-url}/adaptive-multi-agent[Akka adaptive multi-agent sample, window="new"] implements the https://microsoft.github.io/autogen/stable/user-guide/agentchat-user-guide/magentic-one.html[MagenticOne pattern, window="new"].
