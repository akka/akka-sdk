...
----
include::java:example$doc-snippets/src/main/java/patterns/ConcurrentWorkflow.java[tag=concurrent-step]
----
...
* https://github.com/akka-samples/multi-agent[multi-agent, window="new"] - Our classic multi-agent sample
...
Additionally, the link:https://github.com/akka-samples/adaptive-multi-agent[Akka adaptive multi-agent sample, window="new"] implements the https://microsoft.github.io/autogen/stable/user-guide/agentchat-user-guide/magentic-one.html[MagenticOne pattern, window="new"].
