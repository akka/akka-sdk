...
image:geo-data-replication-c.png[Geo data replication, width=600]
...
image:geo-data-replication-d.png[Geo data replication, width=600]

When Bob travels to the USA, read requests that Bob makes on his data are handled locally image:steps-1.svg[width=20], while write requests are forwarded to the UK image:steps-2.svg[width=20].

image:geo-data-replication-e.png[Geo data replication, width=600]

Meanwhile, all requests made by Alice on her data are handled locally image:steps-4.svg[width=20] and get an immediate reply image:steps-5.svg[width=20]. The write operations are being replicated to the UK image:steps-6.svg[width=20].
