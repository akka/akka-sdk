...
==== image:ROOT:key-value-entity.png[Key Value Entities,75] Key Value Entities
...
==== image:ROOT:event-sourced-entity.png[Event Sourced Entities,75] Event Sourced Entities
...
=== image:ROOT:view.png[Views,100] Views
...
=== image:ROOT:consumer.png[Consumers,100] Consumers
...
=== image:ROOT:workflow.png[Workflows, 100] Workflows
...
=== image:ROOT:endpoint.png[Endpoints,100] Endpoints
