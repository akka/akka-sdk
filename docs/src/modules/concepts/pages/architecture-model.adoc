...
==== image:ROOT:key-value-entity.png[Key value entity, width=100] Key Value Entities
...
==== image:ROOT:event-sourced-entity.png[Even sourced entity, width=100] Event Sourced Entities
...
=== image:ROOT:view.png[View, width=100] Views
...
=== image:ROOT:consumer.png[Consumer, width=100] Consumers
...
=== image:ROOT:workflow.png[Workflow, width=100] Workflows
...
=== image:ROOT:endpoint.png[Endpoint, width=100] Endpoints
