...
[#_create_a_project]
== Create a project
All services and applications start as a Java project. Akka has a Maven archetype that makes this easier. You will code your service in this project. See xref:getting-started:author-your-first-service.adoc[] for more details.
