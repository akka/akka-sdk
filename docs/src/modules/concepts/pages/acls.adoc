...
For detailed configuration steps and examples, see the xref:sdk:access-control.adoc[Access Control Lists in the *Developing* section].
...
* xref:sdk:access-control.adoc[] in the *Developing* section
