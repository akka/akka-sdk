...
NOTE: Akka also supports a descriptor for a full project configuration spanning over multiple services and other project-level settings. Please refer to xref:reference:descriptors/project-descriptor.adoc[] for details.
