...
NOTE: Akka supports access management via Single Sign-on (SSO) through the _OpenID Connect_ standard. For details, check xref:reference:security/oidc.adoc[].
...
- xref:reference:security/oidc.adoc[]
