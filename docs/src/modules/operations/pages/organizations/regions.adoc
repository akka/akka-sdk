...
To get a BYOC region setup you can https://www.akka.io/contact[Contact Us].

To learn more about self-hosted Akka regions please To get a BYOC region setup you can https://www.akka.io/contact[Submit a request] for more information.

== See also

- xref:reference:cli/akka-cli/akka_regions.adoc#_see_also[`akka regions` commands]
- xref:reference:cli/akka-cli/akka_projects_regions.adoc#_see_also[`akka project regions` commands]
