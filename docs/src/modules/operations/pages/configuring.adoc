...
[source,yml]
----
include::sdk:example$doc-snippets/standalone/docker-compose.yml[]
----
...
[source,yml]
----
include::sdk:example$doc-snippets/standalone/namespace.yml[]
----
...
[source,yaml]
----
include::sdk:example$doc-snippets/standalone/rbac.yml[]
----
...
[source,yaml]
----
include::sdk:example$doc-snippets/standalone/deployment.yml[]
----
+
...
[source,yaml]
----
include::sdk:example$doc-snippets/standalone/service.yml[]
----
