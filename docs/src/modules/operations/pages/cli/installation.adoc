...
The recommended approach to install `akka` on Linux is using the Debian package repository:
...
If `akka` is already installed, and you want to upgrade to the latest version, you can run:
...
The recommended approach to install `akka` on Windows is using https://learn.microsoft.com/en-us/windows/package-manager/winget/[winget]:
