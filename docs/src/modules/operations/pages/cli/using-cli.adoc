...
For a full reference of all available commands, see the xref:reference:cli/index.adoc[reference] page.
[TIP]
====
...
akka auth -h
----
ifdef::todo[TODO:  You can also refer to the xref:reference:cli/akka_auth.adoc[auth] page.]
...
ifdef::todo[TODO:  For more commands, see the xref:reference:cli/akka_projects.adoc[projects] page.]
...
ifdef::todo[TODO:  For more details, see `akka docker -h` or visit xref:reference:cli/akka_docker.adoc[docker] page.]
[NOTE]
====
...
ifdef::todo[TODO:  More information about this command in xref:reference:cli/akka_services_components_list-events.adoc[components] page.]
====

== Related documentation

- xref:cli/command-completion.adoc[]
- xref:reference:cli/index.adoc[]
