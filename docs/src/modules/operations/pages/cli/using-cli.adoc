...
For more commands, see the xref:reference:cli/akka_projects.adoc[projects] page.
...
TODO:  For more details, see `akka docker -h` or visit xref:reference:cli/akka_docker.adoc[docker] page.
[NOTE]
====
...
More information about this command in xref:reference:cli/akka_services_components_list-events.adoc[components] page.
====
