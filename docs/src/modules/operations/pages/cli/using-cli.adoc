...
Ensure you have set up your container registry credentials before deploying. For more details, see xref:projects/container-registries.adoc[container registry] page.
...
More information about this command in xref:reference:cli/akka-cli/akka_services_components_entities_list-events.adoc[entities] page.
====
