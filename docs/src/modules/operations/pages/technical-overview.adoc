...
| *Dedicated*
2+| Akka hosts and operates the region in Akka's cloud, so there is nothing for you to install or provision. When you prepare to go live, review the xref:operations:production-readiness/dedicated/checklist.adoc[Dedicated production readiness].

| *BYOC*
| Akka provisions and operates the region in your own cloud account.
| xref:operations:technical-overview/byoc.adoc[Get started with BYOC]

| *BYOK8s*
| Akka installs and operates the platform on a cluster you provide.
| xref:operations:technical-overview/byok8s-requirements.adoc[Get started with BYOK8s]
|===
