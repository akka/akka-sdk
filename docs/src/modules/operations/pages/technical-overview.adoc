...
:page-summary: A technical overview of Akka Automated Operations (AAO): the two-plane architecture, what Akka automates and provisions, the shared-responsibility split, and how a region is installed and operated, ending with the setup path for each deployment model and cloud.
...
Choose your deployment model and follow its setup page. Each setup page ends by letting you choose your cloud.
...
* *BYOC*: Akka provisions and operates a region inside your own cloud account. Start with the xref:operations:technical-overview/byoc.adoc[Bring Your Own Cloud setup] (install flow, `akka-bootstrap`, and identity model), then choose your cloud.
* *BYOK8s*: you provision the Kubernetes cluster to Akka's specification. Start with the xref:operations:technical-overview/byok8s-requirements.adoc[BYOK8s requirements], then choose your cloud.
