...
Each span also carries the resource attributes of the service that produced it. To declare attributes of your own, see xref:operations:observability-and-monitoring/observability-exports.adoc#custom_resource_attributes[Adding custom resource attributes].
