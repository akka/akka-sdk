...
- xref:reference:cli/akka_projects_new.adoc#_see_also[`akka projects new` commands]
- xref:reference:cli/akka_projects_get.adoc#_see_also[`akka projects get` commands]
