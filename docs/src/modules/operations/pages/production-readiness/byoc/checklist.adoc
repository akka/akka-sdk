...
* [ ] Exporter configured (OTLP (OpenTelemetry Protocol), Prometheus, Splunk HEC (HTTP Event Collector), Azure Monitor, Google Cloud) pointing at your enterprise platform
