...
:page-summary: The customer-side checklist Akka expects an application to satisfy before going live in a BYOC deployment, covering sizing, observability, CI/CD, testing, multi-region, sign-off, and post-launch.
...
.*Akka's side*
====
Akka runs a parallel internal pre-production validation against the platform-side commitments captured in the RACI: backups, replication, observability stack, baseline regional alerts, certificate monitoring, and similar. This page covers the customer-side complement; the two are designed to pair.
====
...
[NOTE]
====
This page is part of the BYOC Shared Responsibility Model and is maintained as a living reference, updated periodically as Akka's platform and operational practices evolve. To receive notifications of material updates, email mailto:support@akka.io[support@akka.io].
====
