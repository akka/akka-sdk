...
| Compliance | GDPR Requirements / Data Management | C | C |  |  | Customer is responsible for how services handle PII and to ensure such handling is compliant GDPR (or other applicable privacy regulations). Akka acts as neither controller nor processor of data handled by the Customer's services. | 
|===
