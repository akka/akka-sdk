...
At a glance::
* *Akka*: Runs scheduled DB backups, Velero K8s backups, periodic restore testing, and provides multi-region failover tooling and runbooks. RTO/RPO targets are set by the agreement.
...
Compliance posture (SOC 2 Type II, annual third-party penetration test, current subprocessor list) is published on https://trust.akka.io[trust.akka.io].
====
