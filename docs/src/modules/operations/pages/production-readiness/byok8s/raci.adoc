...
| Backups and Recovery | Database Point-in-Time Recovery (PITR) | C | C |  | A | Customer is responsible for configuring continuous point-in-time recovery (PITR) for the database | 8-day retention
