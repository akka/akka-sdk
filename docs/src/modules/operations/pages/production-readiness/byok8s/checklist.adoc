...
* [ ] Alerts route to PagerDuty/Opsgenie with escalation to Akka's 24/7 incident response
...
Day 2 Ops has no multi-region failover; DR is a cold rebuild. The single most important rehearsal at this tier.
