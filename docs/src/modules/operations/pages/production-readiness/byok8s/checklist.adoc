...
* [ ] Akka control-plane audit events (authentication, project and service lifecycle, IAM and token changes, deploys, descriptor changes, secret rotations, prod-log access) delivered and ingested into your SIEM (Security Information and Event Management), with retention set to your compliance needs
