...
[NOTE]
.*What you own in BYOK8s*
====
In BYOK8s you own the infrastructure beneath the platform, not just the application. Beyond the application, you own:
...
Akka still owns the platform layer: the runtime, operators, inter-component mTLS, region installation, scaling logic, platform observability, and releases.
====
...
| Compute & storage scaling | Shared | Customer ensures cluster and database can scale; Akka manages elasticity of the application workloads on top.
