...
:page-summary: How operational responsibilities are divided between Akka and the customer when running Akka Automated Operations (AAO) inside a Kubernetes cluster the customer provides and operates, under the BYOK8s deployment model.
