...
The Customer brings the cloud account and the Kubernetes cluster at the bottom and owns the applications at the top. Akka runs inside the Customer's cluster and manages the platform components in the middle.

....
==================================================================
  Customer Applications (Akka SDK services)          Customer owns
==================================================================
    * Source, build, deploy
    * Service config & secrets
    * App ACLs / IAM (JWTs)
    * App observability / SDK logs

==================================================================
  Akka Platform                                          Akka owns
  (managed by Akka, deployed into the Customer's cluster)
==================================================================
    * Akka runtime & operators
    * Inter-component mTLS
    * Scaling, patching, releases
    * Federation Plane integration
    * Platform observability

==================================================================
  Cloud Account, Kubernetes Cluster & Database       Customer owns
==================================================================
    * Billing, quotas, dedicated cloud account
    * Kubernetes cluster (creation, upgrades, capacity)
    * Database (creation, upgrades, backups)
    * IAM that grants Akka access into the cluster
    * CIDR allocation, peering, DNS, IP allowlists
    * Customer-managed KMS keys, cloud audit logs
....
