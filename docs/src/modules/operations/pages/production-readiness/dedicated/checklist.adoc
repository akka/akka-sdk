...
* [ ] New on-call engineers onboarded before joining the rotation: each alert seen firing in dev, a deploy and a rollback performed, and at least one DR or chaos drill attended
