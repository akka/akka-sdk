...
:page-related: xref:operations:technical-overview/byoc-aws.adoc[], xref:operations:technical-overview/byok8s-requirements.adoc[], xref:operations:technical-overview/data-flows.adoc[]
...
[NOTE]
====
Download link:../_attachments/whitepapers/aao-byok8s-aws.pdf[BYOK8s on AWS as a PDF, window=_blank], or the link:../_attachments/whitepapers/aao-technical-overview-full.pdf[full overview, window=_blank].
====
...
* xref:operations:technical-overview/byoc-aws.adoc[BYOC on AWS]: the AWS resource inventory and identity model
