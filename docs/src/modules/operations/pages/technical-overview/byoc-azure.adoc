...
:page-summary: Azure-specific setup for Akka Automated Operations under Bring Your Own Cloud: the resources Akka provisions, the identity model, resource providers to register, private connectivity, and the Azure values.hcl.
:page-when-to-use: Use this when Akka provisions an AAO region into your Azure subscription under Bring Your Own Cloud.
