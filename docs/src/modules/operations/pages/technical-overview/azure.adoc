...
[NOTE]
====
Download link:../_attachments/whitepapers/aao-byoc-azure.pdf[BYOC on Azure as a PDF, window=_blank], or the link:../_attachments/whitepapers/aao-technical-overview-full.pdf[full overview, window=_blank].
====
