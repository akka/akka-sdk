...
[NOTE]
====
Download link:../_attachments/whitepapers/aao-azure.pdf[this page as a PDF, window=_blank], or the link:../_attachments/whitepapers/aao-technical-overview-full.pdf[full overview, window=_blank].
====
