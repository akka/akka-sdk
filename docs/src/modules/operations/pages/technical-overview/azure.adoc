...
// DIAGRAM: recreated as a themed SVG from the original whitepaper Azure drawings. Flagged for creator review.
image::operations:aao-azure-architecture.svg[AAO on Azure]
