...
Services built with the Akka SDK are transferable between self-managed nodes and fully-automated regions without code modification. The transition happens through a simple re-build and configuration change.
