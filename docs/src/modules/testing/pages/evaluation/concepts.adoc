...
:page-related: xref:testing:evaluation/eval-cases-and-rules.adoc[], xref:testing:evaluation/evaluators.adoc[], xref:testing:evaluation/experiments.adoc[]
...
Experiment class::
Your JUnit test class that assembles the pieces above and calls `ExperimentRunner.run(...)`. A convention, not an SDK type. Named `*Experiment.java` by convention, gated on `-Deval=true`.
...
* xref:testing:evaluation/experiments.adoc[]. Building an experiment setup and running it.
