...
:page-summary: An experiment is a named set of eval cases that run together against one target. A run is one execution of it, and what the run produced is what a report is rendered from.
...
:page-related: xref:testing:evaluation/evaluators.adoc[], xref:testing:evaluation/eval-cases-and-rules.adoc[], xref:testing:evaluation/remote-experiments.adoc[], xref:testing:evaluation/baselines.adoc[], xref:testing:evaluation/reports.adoc[]
:page-banner: evaluations

include::ROOT:partial$include.adoc[]

An experiment is a named set of eval cases that runs together against one target.
...
`mvn verify -Deval=true` walks every experiment class under `src/test/java/<pkg>/eval/`.
...
For dispatching an experiment to a running evaluation service instead of running it in-process, see xref:testing:evaluation/remote-experiments.adoc[].
...
* xref:testing:evaluation/remote-experiments.adoc[]. Dispatching to the offline-evals service.
