...
:page-related: xref:testing:evaluation/experiments.adoc[], xref:testing:evaluation/evaluators.adoc[], xref:testing:evaluation/baselines.adoc[]
...
See xref:testing:evaluation/experiments.adoc[] for turning a run into the record it renders from.
...
A measure the experiment never touched still prints as a zero row.
...
* xref:testing:evaluation/experiments.adoc[]. How an experiment carries the identity the header prints.
