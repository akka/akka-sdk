...
The judge receives the criterion and the `Interaction`: the input the agent was given, the reply, and the tool calls with their arguments, results and errors.
