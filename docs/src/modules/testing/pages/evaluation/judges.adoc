...
`Gate.evaluatorPassRateShouldBeAtLeast(Evaluators.JUDGE, minimumRate)` rates the `judge` evaluator over the cases where it was conclusive, and fails when it judged no case.
