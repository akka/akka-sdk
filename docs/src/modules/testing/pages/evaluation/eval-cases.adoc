...
A custom evaluator implements link:{attachmentsdir}/testkit/akka/javasdk/testkit/eval/Evaluator.html[Evaluator]: one method that receives the case and everything the runtime traced for the turn.
...
----
<1> The name the report prints and a gate can rate.
