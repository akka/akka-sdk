...
| The predicate accepts the reply. Use it for a check the other evaluators do not express, such as a refusal in any language, a semantic match, or a lookup in your own dataset. The result is a pass or a fail, never inconclusive. The name must not be one of the built-in names above.
|===
