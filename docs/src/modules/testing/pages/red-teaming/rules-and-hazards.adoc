...
:page-related: xref:testing:red-teaming/scorers.adoc[], xref:testing:red-teaming/reports.adoc[], xref:testing:red-teaming/reference/hazards.adoc[]
...
The report groups the outcomes by the hazard the rule covers, and the hazard taxonomy is what CI dashboards and compliance reviews read the run by.
