...
:page-related: xref:testing:red-teaming/techniques.adoc[], xref:testing:red-teaming/scorers.adoc[], xref:testing:red-teaming/reports.adoc[]
...
The same `RefusalConsistencyScorer` redkit uses in tests can run as a guardrail in production; see xref:sdk:agents/guardrails.adoc[].
