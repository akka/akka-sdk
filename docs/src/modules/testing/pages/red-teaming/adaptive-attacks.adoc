...
:page-when-to-use: Use when a target resists the first prompt and the attacker's job is to find a way through. PAIR, Crescendo, and Tree-of-Attacks are the standard techniques the pack ships.
