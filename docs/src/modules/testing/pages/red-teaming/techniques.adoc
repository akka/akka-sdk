...
:page-related: xref:testing:red-teaming/adaptive-attacks.adoc[], xref:testing:red-teaming/evaluators.adoc[], xref:testing:red-teaming/campaigns.adoc[]
...
Two kinds ship: static techniques are pure functions the runner can parallelise across the corpus, and adaptive techniques are stateful attackers the runner drives turn-by-turn.
