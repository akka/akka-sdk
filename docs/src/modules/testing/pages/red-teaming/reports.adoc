...
:page-related: xref:testing:red-teaming/experiments.adoc[], xref:testing:red-teaming/evaluators.adoc[], xref:testing:red-teaming/attestation.adoc[]
:page-banner: evaluations

include::ROOT:partial$include.adoc[]

`RedTeamPanels.render()` writes a plain 80-column ASCII report to `target/redkit/reports/<experiment>.txt`.
...
== Panel 1: What the experiment found
...
== Panel 7: What the experiment could not tell you
...
* xref:testing:red-teaming/experiments.adoc[]. How the experiment carries the identity the header prints.
