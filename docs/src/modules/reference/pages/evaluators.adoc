...
* xref:testing:evaluation/evaluators.adoc[]. Writing custom evaluation evaluators.
* xref:testing:red-teaming/evaluators.adoc[]. Writing custom adversarial evaluators.
