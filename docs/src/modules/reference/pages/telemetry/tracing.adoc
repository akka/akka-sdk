...
This reference covers span attributes. A span also carries the resource attributes of its service, which you can extend with xref:operations:observability-and-monitoring/observability-exports.adoc#custom_resource_attributes[custom resource attributes].
