...
* Akka SDK 3.3.0
  - User logic now runs on virtual threads. This includes some breaking API changes, see xref:reference/pages:migration-guide.adoc[migration guide] for details.
