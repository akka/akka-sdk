...
Workflows get xref:sdk:workflows.adoc[a redesigned, more type-safe and fluent API] that makes defining multi-step processes more intuitive. Workflows can now emit streams of real-time notifications to subscribers, keeping clients and downstream systems informed as individual workflows progress through their steps.
