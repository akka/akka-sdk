...
- `akka local console` - Updated with a new TUI
- `akka code token` - Command for provisioning a Akka download token
- `akka code init` - Command for quickly creating a new Akka SDK project
