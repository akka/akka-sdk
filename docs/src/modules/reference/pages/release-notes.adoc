...
Each Akka Runtime release also has its own page, with the behavior changes, fixes, and dependency updates it contains. See xref:release-notes/runtime/index.adoc[Akka Runtime release notes].
