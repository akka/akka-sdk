...
Classifiers are registered separately from rulesets, and registration is immutable. See xref:reference:inference-cli/routing.adoc#routing-classifiers[`akka routing-classifiers`] for the commands that manage them.
