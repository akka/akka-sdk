...
Classifiers are registered separately from rulesets, and registration is immutable. See xref:reference:cli/inference/akka-optimize.adoc#routing-classifiers[`akka optimize routing-classifiers`] for the commands that manage them.
