...
* link:cli/akka_organizations_auth_add_openid[akka organizations auth add openid]	 - Add an OpenID authentication domain to the current (or specified) organization
