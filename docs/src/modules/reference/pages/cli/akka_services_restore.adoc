...
Restore a service that was deleted in the past two weeks.

== Synopsis

The `akka service restore _service-name_` command restores a service and its data that was deleted in the past two weeks.
