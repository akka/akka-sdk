...
* link:cli/akka_projects_tokens_create[akka projects tokens create]	 - Create a service token
* link:cli/akka_projects_tokens_list[akka projects tokens list]	 - List all service tokens
* link:cli/akka_projects_tokens_revoke[akka projects tokens revoke]	 - revoke service token
