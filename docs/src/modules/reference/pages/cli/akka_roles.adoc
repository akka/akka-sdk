...
* link:cli/akka_roles_add-binding[akka roles add-binding]	 - Add a role binding.
* link:cli/akka_roles_delete-binding[akka roles delete-binding]	 - Delete a role binding.
* link:cli/akka_roles_invitations[akka roles invitations]	 - Manage invitations to user roles on a project.
* link:cli/akka_roles_list[akka roles list]	 - List project roles.
* link:cli/akka_roles_list-bindings[akka roles list-bindings]	 - List project role bindings.
