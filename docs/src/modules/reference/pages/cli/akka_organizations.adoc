...
* link:cli/akka_organizations_get[akka organizations get]	 - Get organization information.
* link:cli/akka_organizations_invitations[akka organizations invitations]	 - Invite new users to the organization with a specific role.
* link:cli/akka_organizations_list[akka organizations list]	 - List all organizations of which the user is a member of.
* link:cli/akka_organizations_users[akka organizations users]	 - Manage organization users.
