= akka models
:page-summary: The complete command reference for serving models, covering deployments, devices, accelerators, routes, and API keys.
:page-persona: builder-ai-ml, operator
:page-banner: inference

include::ROOT:partial$include.adoc[]

The `akka models` commands deploy models to an inference cluster and expose them on a hostname. See xref:inference:serving/index.adoc[Serving models] for the tasks these commands support, and xref:reference:descriptors/model-descriptor.adoc[Model descriptor] for the file they apply.
