...
Summarize all services connectivity and status.

== Synopsis

The `akka local services connectivity` command summarizes of all service connectivity under your current project.
