...
* link:cli/akka_services_views_describe[akka services views describe]	 - Describe a view.
* link:cli/akka_services_views_drop[akka services views drop]	 - Delete the data for an inactive view.
* link:cli/akka_services_views_list[akka services views list]	 - List all views.
