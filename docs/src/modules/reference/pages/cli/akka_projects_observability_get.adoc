...
Get observability configuration for your Akka project.

== Synopsis

The `akka project observability get` command will display the observability configuration for your project.
