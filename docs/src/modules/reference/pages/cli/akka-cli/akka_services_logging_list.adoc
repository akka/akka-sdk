...
Use --region to select another region, or --all-regions to list the configuration of every region of the project.
...
> akka service logging list my-service --all-regions
----
