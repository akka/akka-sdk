= akka secrets external update gcp

Update a GCP external secret in the current project.

== Synopsis

The `akka secrets external update gcp` command updates a GCP external secret in the currently configured project.

----
akka secrets external update gcp SECRET_NAME [flags]
----
...
----
  ...
  -h, --help                           help for gcp
      ...
      --unset-location                 Unset the default location for the secret.
      --unset-object-file-permission   Unset the file permission of the object.
      --unset-object-location          Unset the location of the object.
      --unset-object-project-id        Unset the project id of the object.
