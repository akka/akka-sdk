= akka projects observability remove metrics otlp

Remove an OTLP gRPC exporter from metrics by endpoint.

----
akka projects observability remove metrics otlp [flags]
----
