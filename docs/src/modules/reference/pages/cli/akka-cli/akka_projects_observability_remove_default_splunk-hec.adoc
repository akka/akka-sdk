= akka projects observability remove default splunk-hec

Remove a Splunk HEC exporter from default by endpoint.

----
akka projects observability remove default splunk-hec [flags]
----
