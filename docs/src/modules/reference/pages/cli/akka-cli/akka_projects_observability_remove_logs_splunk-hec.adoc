= akka projects observability remove logs splunk-hec

Remove a Splunk HEC exporter from logs by endpoint.

----
akka projects observability remove logs splunk-hec [flags]
----
