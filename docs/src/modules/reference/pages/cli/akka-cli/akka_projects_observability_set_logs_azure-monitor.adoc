= akka projects observability set logs azure-monitor

Set your project to export logs to Azure Monitor.

----
akka projects observability set logs azure-monitor [flags]
----
