...
The `akka service components get-workflow-execution` command gets workflow execution details for the specified service, workflow component and id

----
akka services components get-workflow SERVICE_NAME COMPONENT_ID WORKFLOW_ID [flags]
----
