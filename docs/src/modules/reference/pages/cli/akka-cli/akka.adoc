...
----
  ...
  -v, --version             Print the akka CLI version
----
...
* link:akka_mcp.html[akka mcp]	 - [Incubating] MCP server for AI agent integration.
...
* link:akka_service-configs.html[akka service-configs]	 - Manage service configs for a Akka project.
