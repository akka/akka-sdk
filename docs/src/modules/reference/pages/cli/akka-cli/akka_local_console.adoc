...
----
      --force-asset-check   This forces a check for a new version of the local console assets.
  -h, --help                help for console
  -p, --port uint16         The port on which the local console will run. (default 9889)
----
