...
* xref:reference:cli/akka-cli/akka_specify_attest.adoc[akka specify attest]
* xref:reference:cli/akka-cli/akka_specify_auditor-test.adoc[akka specify auditor-test]
* xref:reference:cli/akka-cli/akka_specify_conditions.adoc[akka specify conditions]
* xref:reference:cli/akka-cli/akka_specify_conditions_author.adoc[akka specify conditions author]
* xref:reference:cli/akka-cli/akka_specify_conditions_graduate.adoc[akka specify conditions graduate]
* xref:reference:cli/akka-cli/akka_specify_conditions_list.adoc[akka specify conditions list]
* xref:reference:cli/akka-cli/akka_specify_conform.adoc[akka specify conform]
* xref:reference:cli/akka-cli/akka_specify_docs.adoc[akka specify docs]
* xref:reference:cli/akka-cli/akka_specify_extension.adoc[akka specify extension]
* xref:reference:cli/akka-cli/akka_specify_extension_verify.adoc[akka specify extension verify]
* xref:reference:cli/akka-cli/akka_specify_init.adoc[akka specify init]
* xref:reference:cli/akka-cli/akka_specify_mode.adoc[akka specify mode]
* xref:reference:cli/akka-cli/akka_specify_probes.adoc[akka specify probes]
* xref:reference:cli/akka-cli/akka_specify_probes_approve.adoc[akka specify probes approve]
* xref:reference:cli/akka-cli/akka_specify_probes_list.adoc[akka specify probes list]
* xref:reference:cli/akka-cli/akka_specify_probes_run.adoc[akka specify probes run]
* xref:reference:cli/akka-cli/akka_specify_probes_test.adoc[akka specify probes test]
* xref:reference:cli/akka-cli/akka_specify_ship.adoc[akka specify ship]
* xref:reference:cli/akka-cli/akka_specify_signoff.adoc[akka specify signoff]
* xref:reference:cli/akka-cli/akka_specify_status.adoc[akka specify status]
* xref:reference:cli/akka-cli/akka_specify_strike.adoc[akka specify strike]
* xref:reference:cli/akka-cli/akka_specify_waive.adoc[akka specify waive]
...
* xref:reference:cli/akka-cli/akka_code_check.adoc[akka code check]
* xref:reference:cli/akka-cli/akka_code_context-update.adoc[akka code context-update]
* xref:reference:cli/akka-cli/akka_code_init.adoc[akka code init]
* xref:reference:cli/akka-cli/akka_code_token.adoc[akka code token]
...
* xref:reference:cli/akka-cli/akka_organizations_auth_test.adoc[akka organizations auth test]
...
* xref:reference:cli/akka-cli/akka_organizations_identity-providers.adoc[akka organizations identity-providers]
* xref:reference:cli/akka-cli/akka_organizations_identity-providers_add.adoc[akka organizations identity-providers add]
...
* xref:reference:cli/akka-cli/akka_organizations_identity-providers_list.adoc[akka organizations identity-providers list]
* xref:reference:cli/akka-cli/akka_organizations_identity-providers_remove.adoc[akka organizations identity-providers remove]
* xref:reference:cli/akka-cli/akka_organizations_identity-providers_show.adoc[akka organizations identity-providers show]
* xref:reference:cli/akka-cli/akka_organizations_identity-providers_update.adoc[akka organizations identity-providers update]
* xref:reference:cli/akka-cli/akka_organizations_identity-providers_update_oauth.adoc[akka organizations identity-providers update oauth]
...
* xref:reference:cli/akka-cli/akka_organizations_stores.adoc[akka organizations stores]
* xref:reference:cli/akka-cli/akka_organizations_stores_list.adoc[akka organizations stores list]
...
* xref:reference:cli/akka-cli/akka_projects_apply.adoc[akka projects apply]
...
* xref:reference:cli/akka-cli/akka_projects_config_get_object-storage.adoc[akka projects config get object-storage]
...
* xref:reference:cli/akka-cli/akka_projects_config_set_object-storage.adoc[akka projects config set object-storage]
* xref:reference:cli/akka-cli/akka_projects_config_set_object-storage_bucket.adoc[akka projects config set object-storage bucket]
...
* xref:reference:cli/akka-cli/akka_projects_config_unset_object-storage.adoc[akka projects config unset object-storage]
* xref:reference:cli/akka-cli/akka_projects_config_unset_object-storage_bucket.adoc[akka projects config unset object-storage bucket]
* xref:reference:cli/akka-cli/akka_projects_delete.adoc[akka projects delete]
* xref:reference:cli/akka-cli/akka_projects_export.adoc[akka projects export]
...
* xref:reference:cli/akka-cli/akka_projects_instance-types.adoc[akka projects instance-types]
* xref:reference:cli/akka-cli/akka_projects_instance-types_list.adoc[akka projects instance-types list]
* xref:reference:cli/akka-cli/akka_projects_list.adoc[akka projects list]
* xref:reference:cli/akka-cli/akka_projects_network-policy.adoc[akka projects network-policy]
* xref:reference:cli/akka-cli/akka_projects_network-policy_add.adoc[akka projects network-policy add]
* xref:reference:cli/akka-cli/akka_projects_network-policy_add_egress-rule.adoc[akka projects network-policy add egress-rule]
* xref:reference:cli/akka-cli/akka_projects_network-policy_add_ingress-rule.adoc[akka projects network-policy add ingress-rule]
* xref:reference:cli/akka-cli/akka_projects_network-policy_apply.adoc[akka projects network-policy apply]
* xref:reference:cli/akka-cli/akka_projects_network-policy_edit.adoc[akka projects network-policy edit]
* xref:reference:cli/akka-cli/akka_projects_network-policy_export.adoc[akka projects network-policy export]
* xref:reference:cli/akka-cli/akka_projects_network-policy_get.adoc[akka projects network-policy get]
* xref:reference:cli/akka-cli/akka_projects_network-policy_remove.adoc[akka projects network-policy remove]
* xref:reference:cli/akka-cli/akka_projects_network-policy_remove_egress-rule.adoc[akka projects network-policy remove egress-rule]
* xref:reference:cli/akka-cli/akka_projects_network-policy_remove_ingress-rule.adoc[akka projects network-policy remove ingress-rule]
...
* xref:reference:cli/akka-cli/akka_projects_observability_add.adoc[akka projects observability add]
* xref:reference:cli/akka-cli/akka_projects_observability_add_default.adoc[akka projects observability add default]
* xref:reference:cli/akka-cli/akka_projects_observability_add_default_azure-monitor.adoc[akka projects observability add default azure-monitor]
* xref:reference:cli/akka-cli/akka_projects_observability_add_default_google-cloud.adoc[akka projects observability add default google-cloud]
* xref:reference:cli/akka-cli/akka_projects_observability_add_default_otlp-http.adoc[akka projects observability add default otlp-http]
* xref:reference:cli/akka-cli/akka_projects_observability_add_default_otlp.adoc[akka projects observability add default otlp]
* xref:reference:cli/akka-cli/akka_projects_observability_add_default_splunk-hec.adoc[akka projects observability add default splunk-hec]
* xref:reference:cli/akka-cli/akka_projects_observability_add_logs.adoc[akka projects observability add logs]
* xref:reference:cli/akka-cli/akka_projects_observability_add_logs_azure-monitor.adoc[akka projects observability add logs azure-monitor]
* xref:reference:cli/akka-cli/akka_projects_observability_add_logs_google-cloud.adoc[akka projects observability add logs google-cloud]
* xref:reference:cli/akka-cli/akka_projects_observability_add_logs_otlp-http.adoc[akka projects observability add logs otlp-http]
* xref:reference:cli/akka-cli/akka_projects_observability_add_logs_otlp.adoc[akka projects observability add logs otlp]
* xref:reference:cli/akka-cli/akka_projects_observability_add_logs_splunk-hec.adoc[akka projects observability add logs splunk-hec]
* xref:reference:cli/akka-cli/akka_projects_observability_add_metrics.adoc[akka projects observability add metrics]
* xref:reference:cli/akka-cli/akka_projects_observability_add_metrics_azure-monitor.adoc[akka projects observability add metrics azure-monitor]
* xref:reference:cli/akka-cli/akka_projects_observability_add_metrics_google-cloud.adoc[akka projects observability add metrics google-cloud]
* xref:reference:cli/akka-cli/akka_projects_observability_add_metrics_otlp-http.adoc[akka projects observability add metrics otlp-http]
* xref:reference:cli/akka-cli/akka_projects_observability_add_metrics_otlp.adoc[akka projects observability add metrics otlp]
* xref:reference:cli/akka-cli/akka_projects_observability_add_metrics_prometheus.adoc[akka projects observability add metrics prometheus]
* xref:reference:cli/akka-cli/akka_projects_observability_add_metrics_splunk-hec.adoc[akka projects observability add metrics splunk-hec]
* xref:reference:cli/akka-cli/akka_projects_observability_add_traces.adoc[akka projects observability add traces]
* xref:reference:cli/akka-cli/akka_projects_observability_add_traces_azure-monitor.adoc[akka projects observability add traces azure-monitor]
* xref:reference:cli/akka-cli/akka_projects_observability_add_traces_google-cloud.adoc[akka projects observability add traces google-cloud]
* xref:reference:cli/akka-cli/akka_projects_observability_add_traces_otlp-http.adoc[akka projects observability add traces otlp-http]
* xref:reference:cli/akka-cli/akka_projects_observability_add_traces_otlp.adoc[akka projects observability add traces otlp]
...
* xref:reference:cli/akka-cli/akka_projects_observability_config_runtime-logs.adoc[akka projects observability config runtime-logs]
...
* xref:reference:cli/akka-cli/akka_projects_observability_remove.adoc[akka projects observability remove]
* xref:reference:cli/akka-cli/akka_projects_observability_remove_default.adoc[akka projects observability remove default]
* xref:reference:cli/akka-cli/akka_projects_observability_remove_default_azure-monitor.adoc[akka projects observability remove default azure-monitor]
* xref:reference:cli/akka-cli/akka_projects_observability_remove_default_google-cloud.adoc[akka projects observability remove default google-cloud]
* xref:reference:cli/akka-cli/akka_projects_observability_remove_default_otlp-http.adoc[akka projects observability remove default otlp-http]
* xref:reference:cli/akka-cli/akka_projects_observability_remove_default_otlp.adoc[akka projects observability remove default otlp]
* xref:reference:cli/akka-cli/akka_projects_observability_remove_default_splunk-hec.adoc[akka projects observability remove default splunk-hec]
* xref:reference:cli/akka-cli/akka_projects_observability_remove_logs.adoc[akka projects observability remove logs]
* xref:reference:cli/akka-cli/akka_projects_observability_remove_logs_azure-monitor.adoc[akka projects observability remove logs azure-monitor]
* xref:reference:cli/akka-cli/akka_projects_observability_remove_logs_google-cloud.adoc[akka projects observability remove logs google-cloud]
* xref:reference:cli/akka-cli/akka_projects_observability_remove_logs_otlp-http.adoc[akka projects observability remove logs otlp-http]
* xref:reference:cli/akka-cli/akka_projects_observability_remove_logs_otlp.adoc[akka projects observability remove logs otlp]
* xref:reference:cli/akka-cli/akka_projects_observability_remove_logs_splunk-hec.adoc[akka projects observability remove logs splunk-hec]
* xref:reference:cli/akka-cli/akka_projects_observability_remove_metrics.adoc[akka projects observability remove metrics]
* xref:reference:cli/akka-cli/akka_projects_observability_remove_metrics_azure-monitor.adoc[akka projects observability remove metrics azure-monitor]
* xref:reference:cli/akka-cli/akka_projects_observability_remove_metrics_google-cloud.adoc[akka projects observability remove metrics google-cloud]
* xref:reference:cli/akka-cli/akka_projects_observability_remove_metrics_otlp-http.adoc[akka projects observability remove metrics otlp-http]
* xref:reference:cli/akka-cli/akka_projects_observability_remove_metrics_otlp.adoc[akka projects observability remove metrics otlp]
* xref:reference:cli/akka-cli/akka_projects_observability_remove_metrics_prometheus.adoc[akka projects observability remove metrics prometheus]
* xref:reference:cli/akka-cli/akka_projects_observability_remove_metrics_splunk-hec.adoc[akka projects observability remove metrics splunk-hec]
* xref:reference:cli/akka-cli/akka_projects_observability_remove_traces.adoc[akka projects observability remove traces]
* xref:reference:cli/akka-cli/akka_projects_observability_remove_traces_azure-monitor.adoc[akka projects observability remove traces azure-monitor]
* xref:reference:cli/akka-cli/akka_projects_observability_remove_traces_google-cloud.adoc[akka projects observability remove traces google-cloud]
* xref:reference:cli/akka-cli/akka_projects_observability_remove_traces_otlp-http.adoc[akka projects observability remove traces otlp-http]
* xref:reference:cli/akka-cli/akka_projects_observability_remove_traces_otlp.adoc[akka projects observability remove traces otlp]
...
* xref:reference:cli/akka-cli/akka_projects_observability_set_default_azure-monitor.adoc[akka projects observability set default azure-monitor]
...
* xref:reference:cli/akka-cli/akka_projects_observability_set_logs_azure-monitor.adoc[akka projects observability set logs azure-monitor]
...
* xref:reference:cli/akka-cli/akka_projects_observability_set_metrics_azure-monitor.adoc[akka projects observability set metrics azure-monitor]
...
* xref:reference:cli/akka-cli/akka_projects_observability_set_traces_azure-monitor.adoc[akka projects observability set traces azure-monitor]
...
* xref:reference:cli/akka-cli/akka_projects_regions_workload-identity-info.adoc[akka projects regions workload-identity-info]
* xref:reference:cli/akka-cli/akka_projects_settings.adoc[akka projects settings]
* xref:reference:cli/akka-cli/akka_projects_settings_bring-up-region.adoc[akka projects settings bring-up-region]
...
* xref:reference:cli/akka-cli/akka_secrets_external.adoc[akka secrets external]
* xref:reference:cli/akka-cli/akka_secrets_external_create.adoc[akka secrets external create]
* xref:reference:cli/akka-cli/akka_secrets_external_create_aws.adoc[akka secrets external create aws]
* xref:reference:cli/akka-cli/akka_secrets_external_create_azure.adoc[akka secrets external create azure]
* xref:reference:cli/akka-cli/akka_secrets_external_create_gcp.adoc[akka secrets external create gcp]
* xref:reference:cli/akka-cli/akka_secrets_external_delete.adoc[akka secrets external delete]
* xref:reference:cli/akka-cli/akka_secrets_external_get.adoc[akka secrets external get]
* xref:reference:cli/akka-cli/akka_secrets_external_info.adoc[akka secrets external info]
* xref:reference:cli/akka-cli/akka_secrets_external_list.adoc[akka secrets external list]
* xref:reference:cli/akka-cli/akka_secrets_external_update.adoc[akka secrets external update]
* xref:reference:cli/akka-cli/akka_secrets_external_update_aws.adoc[akka secrets external update aws]
* xref:reference:cli/akka-cli/akka_secrets_external_update_azure.adoc[akka secrets external update azure]
* xref:reference:cli/akka-cli/akka_secrets_external_update_gcp.adoc[akka secrets external update gcp]
...
* xref:reference:cli/akka-cli/akka_services_components_agents.adoc[akka services components agents]
* xref:reference:cli/akka-cli/akka_services_components_agents_instances.adoc[akka services components agents instances]
* xref:reference:cli/akka-cli/akka_services_components_agents_instances_describe.adoc[akka services components agents instances describe]
* xref:reference:cli/akka-cli/akka_services_components_agents_instances_list.adoc[akka services components agents instances list]
* xref:reference:cli/akka-cli/akka_services_components_agents_instances_resume.adoc[akka services components agents instances resume]
* xref:reference:cli/akka-cli/akka_services_components_agents_instances_suspend.adoc[akka services components agents instances suspend]
* xref:reference:cli/akka-cli/akka_services_components_agents_instances_terminate.adoc[akka services components agents instances terminate]
* xref:reference:cli/akka-cli/akka_services_components_agents_interactions.adoc[akka services components agents interactions]
* xref:reference:cli/akka-cli/akka_services_components_agents_interactions_list.adoc[akka services components agents interactions list]
* xref:reference:cli/akka-cli/akka_services_components_entities.adoc[akka services components entities]
* xref:reference:cli/akka-cli/akka_services_components_entities_delete-snapshot.adoc[akka services components entities delete-snapshot]
* xref:reference:cli/akka-cli/akka_services_components_entities_force-snapshot.adoc[akka services components entities force-snapshot]
* xref:reference:cli/akka-cli/akka_services_components_entities_get-state.adoc[akka services components entities get-state]
* xref:reference:cli/akka-cli/akka_services_components_entities_list-events.adoc[akka services components entities list-events]
* xref:reference:cli/akka-cli/akka_services_components_entities_list-ids.adoc[akka services components entities list-ids]
* xref:reference:cli/akka-cli/akka_services_components_list-interactions.adoc[akka services components list-interactions]
...
* xref:reference:cli/akka-cli/akka_services_components_workflows.adoc[akka services components workflows]
* xref:reference:cli/akka-cli/akka_services_components_workflows_delete-snapshot.adoc[akka services components workflows delete-snapshot]
* xref:reference:cli/akka-cli/akka_services_components_workflows_force-snapshot.adoc[akka services components workflows force-snapshot]
* xref:reference:cli/akka-cli/akka_services_components_workflows_get-state.adoc[akka services components workflows get-state]
* xref:reference:cli/akka-cli/akka_services_components_workflows_get.adoc[akka services components workflows get]
* xref:reference:cli/akka-cli/akka_services_components_workflows_list-events.adoc[akka services components workflows list-events]
* xref:reference:cli/akka-cli/akka_services_components_workflows_list-ids.adoc[akka services components workflows list-ids]
* xref:reference:cli/akka-cli/akka_services_components_workflows_resume.adoc[akka services components workflows resume]
* xref:reference:cli/akka-cli/akka_services_components_workflows_suspend.adoc[akka services components workflows suspend]
* xref:reference:cli/akka-cli/akka_services_components_workflows_terminate.adoc[akka services components workflows terminate]
...
* xref:reference:cli/akka-cli/akka_services_jwks.adoc[akka services jwks]
* xref:reference:cli/akka-cli/akka_services_jwks_add.adoc[akka services jwks add]
* xref:reference:cli/akka-cli/akka_services_jwks_generate.adoc[akka services jwks generate]
* xref:reference:cli/akka-cli/akka_services_jwks_list.adoc[akka services jwks list]
* xref:reference:cli/akka-cli/akka_services_jwks_migrate.adoc[akka services jwks migrate]
* xref:reference:cli/akka-cli/akka_services_jwks_remove.adoc[akka services jwks remove]
* xref:reference:cli/akka-cli/akka_services_jwks_update.adoc[akka services jwks update]
...
* xref:reference:cli/akka-cli/akka_services_remove-config.adoc[akka services remove-config]
...
* xref:reference:cli/akka-cli/akka_services_set-config.adoc[akka services set-config]
...
* xref:reference:cli/akka-cli/akka_services_views_get-state.adoc[akka services views get-state]
* xref:reference:cli/akka-cli/akka_services_views_list.adoc[akka services views list]
* xref:reference:cli/akka-cli/akka_services_views_query.adoc[akka services views query]

== Inspect service components
The `akka services components` commands let you inspect the state of components.

The xref:reference:cli/akka-cli/akka_services_components.adoc[akka services components] command includes the following options:
...
The xref:reference:cli/akka-cli/akka_service-configs.adoc[akka service-configs] command includes the following options:

* xref:reference:cli/akka-cli/akka_service-configs_create.adoc[akka service-configs create]
* xref:reference:cli/akka-cli/akka_service-configs_delete.adoc[akka service-configs delete]
* xref:reference:cli/akka-cli/akka_service-configs_get.adoc[akka service-configs get]
* xref:reference:cli/akka-cli/akka_service-configs_list.adoc[akka service-configs list]
...
* xref:reference:cli/akka-cli/akka_local_cluster.adoc[akka local cluster]
...
* xref:reference:cli/akka-cli/akka_local_services_components_agents.adoc[akka local services components agents]
* xref:reference:cli/akka-cli/akka_local_services_components_agents_instances.adoc[akka local services components agents instances]
* xref:reference:cli/akka-cli/akka_local_services_components_agents_instances_describe.adoc[akka local services components agents instances describe]
* xref:reference:cli/akka-cli/akka_local_services_components_agents_instances_list.adoc[akka local services components agents instances list]
* xref:reference:cli/akka-cli/akka_local_services_components_agents_instances_resume.adoc[akka local services components agents instances resume]
* xref:reference:cli/akka-cli/akka_local_services_components_agents_instances_suspend.adoc[akka local services components agents instances suspend]
* xref:reference:cli/akka-cli/akka_local_services_components_agents_instances_terminate.adoc[akka local services components agents instances terminate]
* xref:reference:cli/akka-cli/akka_local_services_components_agents_interactions.adoc[akka local services components agents interactions]
* xref:reference:cli/akka-cli/akka_local_services_components_agents_interactions_list.adoc[akka local services components agents interactions list]
* xref:reference:cli/akka-cli/akka_local_services_components_entities.adoc[akka local services components entities]
* xref:reference:cli/akka-cli/akka_local_services_components_entities_delete-snapshot.adoc[akka local services components entities delete-snapshot]
* xref:reference:cli/akka-cli/akka_local_services_components_entities_force-snapshot.adoc[akka local services components entities force-snapshot]
* xref:reference:cli/akka-cli/akka_local_services_components_entities_get-state.adoc[akka local services components entities get-state]
* xref:reference:cli/akka-cli/akka_local_services_components_entities_list-events.adoc[akka local services components entities list-events]
* xref:reference:cli/akka-cli/akka_local_services_components_entities_list-ids.adoc[akka local services components entities list-ids]
* xref:reference:cli/akka-cli/akka_local_services_components_list-interactions.adoc[akka local services components list-interactions]
...
* xref:reference:cli/akka-cli/akka_local_services_components_workflows.adoc[akka local services components workflows]
* xref:reference:cli/akka-cli/akka_local_services_components_workflows_delete-snapshot.adoc[akka local services components workflows delete-snapshot]
* xref:reference:cli/akka-cli/akka_local_services_components_workflows_force-snapshot.adoc[akka local services components workflows force-snapshot]
* xref:reference:cli/akka-cli/akka_local_services_components_workflows_get-state.adoc[akka local services components workflows get-state]
* xref:reference:cli/akka-cli/akka_local_services_components_workflows_get.adoc[akka local services components workflows get]
* xref:reference:cli/akka-cli/akka_local_services_components_workflows_list-events.adoc[akka local services components workflows list-events]
* xref:reference:cli/akka-cli/akka_local_services_components_workflows_list-ids.adoc[akka local services components workflows list-ids]
* xref:reference:cli/akka-cli/akka_local_services_components_workflows_resume.adoc[akka local services components workflows resume]
* xref:reference:cli/akka-cli/akka_local_services_components_workflows_suspend.adoc[akka local services components workflows suspend]
* xref:reference:cli/akka-cli/akka_local_services_components_workflows_terminate.adoc[akka local services components workflows terminate]
...
* xref:reference:cli/akka-cli/akka_local_services_views_get-state.adoc[akka local services views get-state]
* xref:reference:cli/akka-cli/akka_local_services_views_list.adoc[akka local services views list]
* xref:reference:cli/akka-cli/akka_local_services_views_query.adoc[akka local services views query]
* xref:reference:cli/akka-cli/akka_local_start.adoc[akka local start]
* xref:reference:cli/akka-cli/akka_local_status.adoc[akka local status]
* xref:reference:cli/akka-cli/akka_local_stop.adoc[akka local stop]
