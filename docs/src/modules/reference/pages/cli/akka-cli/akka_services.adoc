...
* link:akka_services_remove-config.html[akka services remove-config]	 - Remove the service config from a service.
...
* link:akka_services_set-config.html[akka services set-config]	 - Set the service config for a service.
