...
Resume a service, scaling it back up.

== Synopsis

The `akka service resume _service-name_` command resumes a previously paused service, scaling it back up to the minimum number of instances configured for the service.
