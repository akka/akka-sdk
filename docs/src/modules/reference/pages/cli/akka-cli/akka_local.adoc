...
* link:akka_local_cluster.html[akka local cluster]	 - Start and manage a local Akka cluster
...
* link:akka_local_start.html[akka local start]	 - Start the local development environment in background mode (no TUI).
* link:akka_local_status.html[akka local status]	 - Show status of the local development environment.
* link:akka_local_stop.html[akka local stop]	 - Stop the local development environment daemon.
