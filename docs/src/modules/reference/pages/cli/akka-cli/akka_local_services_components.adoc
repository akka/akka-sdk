...
* link:akka_local_services_components_list-ids.html[akka local services components list-ids]	 - List recently active IDs for the given stateful component served by this service within specified time window (24h by default).
* link:akka_local_services_components_list-interactions.html[akka local services components list-interactions]	 - List interactions from the Agent for the given service and Agent id.
