...
* link:akka_projects_apply.html[akka projects apply]	 - Apply a project descriptor.
...
* link:akka_projects_export.html[akka projects export]	 - Export project resources as a descriptor.
