...
----
      --aws-workload-identity-role-arn string          The role ARN to use for AWS workload identity
      ...
      --gcp-workload-identity-service-account string   The GCP service account to impersonate for GCP workload identity
  -h, --help                                           help for deploy
      --instance-type string                           the service instance type (e.g. "g1.general.small", "g1.memory.large"). Must be permitted by your organization. If unset, the organization default applies.
      ...
      --object-storage string                          name of an object-storage configuration in the project (defaults to 'default' when omitted)
