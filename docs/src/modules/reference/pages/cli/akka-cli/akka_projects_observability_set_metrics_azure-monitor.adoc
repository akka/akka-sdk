= akka projects observability set metrics azure-monitor

Set your project to export metrics to Azure Monitor.

----
akka projects observability set metrics azure-monitor [flags]
----
