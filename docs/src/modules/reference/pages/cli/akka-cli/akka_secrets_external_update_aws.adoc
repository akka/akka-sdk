...
Update an AWS external secret in the current project.

== Synopsis

The `akka secrets external update aws` command updates an AWS external secret in the currently configured project.

----
akka secrets external update aws SECRET_NAME [flags]
----
...
----
  ...
  -h, --help                           help for aws
      ...
      --unset-object-jmes-path         Clear the JMES paths configured for the object.
      --unset-object-version           Unset the version of the object.
      --unset-object-version-label     Unset the version label of the object.
----
