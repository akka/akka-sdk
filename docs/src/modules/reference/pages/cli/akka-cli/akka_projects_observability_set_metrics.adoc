...
* link:akka_projects_observability_set_metrics_azure-monitor.html[akka projects observability set metrics azure-monitor]	 - Set your project to export metrics to Azure Monitor.
