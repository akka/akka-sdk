= akka projects observability remove metrics splunk-hec

Remove a Splunk HEC exporter from metrics by endpoint.

----
akka projects observability remove metrics splunk-hec [flags]
----
