= akka projects observability set default azure-monitor

Set your project to export default to Azure Monitor.

----
akka projects observability set default azure-monitor [flags]
----
