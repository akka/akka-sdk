= akka projects observability remove default otlp

Remove an OTLP gRPC exporter from default by endpoint.

----
akka projects observability remove default otlp [flags]
----
