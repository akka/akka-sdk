= akka projects observability set traces azure-monitor

Set your project to export traces to Azure Monitor.

----
akka projects observability set traces azure-monitor [flags]
----
