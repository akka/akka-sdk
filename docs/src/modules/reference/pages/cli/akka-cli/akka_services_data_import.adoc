...
----
  ...
  -h, --help                                               help for import
      ...
      --include-value-entities                             Whether value entities should be imported. Defaults to false. Only applies to legacy Kalix services.
      ...
      --value-entity-object stringArray                    A storage object name (relative to the bucket and object prefix) to import from. Multiple may be specified. If not specified, the default object names used by the export process are used. Implies --include-value-entities. Only applies to legacy Kalix services.
----
