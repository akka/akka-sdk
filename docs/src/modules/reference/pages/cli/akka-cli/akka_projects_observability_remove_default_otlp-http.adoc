= akka projects observability remove default otlp-http

Remove an OTLP HTTP exporter from default by endpoint.

----
akka projects observability remove default otlp-http [flags]
----
...
----
      ...
      --endpoint-base-url string    The base URL to use. This will have a logs/metrics/traces specific path appended to it.
