= akka projects observability add metrics prometheus

Add a Prometheus Remote Write exporter for metrics.

----
akka projects observability add metrics prometheus [flags]
----
