...
By default the command runs in the primary region.
Use --region to select another region, or --all-regions to run it in every region of the project.
...
> akka service logging set-level my-service com.example.MyClass DEBUG --all-regions
----
