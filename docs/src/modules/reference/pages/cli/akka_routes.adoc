...
* link:cli/akka_routes_create[akka routes create]	 - Create a route.
* link:cli/akka_routes_delete[akka routes delete]	 - Delete a route
* link:cli/akka_routes_edit[akka routes edit]	 - Edit a route
* link:cli/akka_routes_export[akka routes export]	 - Export a single route as YAML
* link:cli/akka_routes_get[akka routes get]	 - Get a single route
* link:cli/akka_routes_list[akka routes list]	 - List all routes.
* link:cli/akka_routes_update[akka routes update]	 - Update a route
