...
4. *Choose the check by delegation* — prefer the tool that already decides this (a compiler, test runner, or linter) as a declarative command; write bespoke logic only when no tool observes the invariant.
