...
NOTE: `/akka:mode` requires the latest version of the Akka CLI. xref:getting-started:quick-install-cli.adoc[Install the Akka CLI] if you have not installed it yet.
