...
structure, page audit, llms.txt generator) lives in `docs-overhaul-spec.md`; the spec takes
...
and as markdown plus `llms.txt` for AI coding assistants (see the README.md). Structure, label, and
