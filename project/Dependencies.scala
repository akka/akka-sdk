...
object Dependencies {
  ...
  val AkkaRuntimeVersion = sys.props.getOrElse("akka-runtime.version", "1.5.46-40-1b723df8-SNAPSHOT")
  ...
  val javaSdk = deps ++= sdkDeps ++ Seq(
    ...
    typesafeConfig,
    // make sure akka-http and akka-stream are on the classpath for users to consume http request/response APIs and streams
