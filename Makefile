...
attributes: prepare
	...
	docs/bin/version.sh | xargs -0  printf ":akka-javasdk-version: %s" \
		> "${managed_partials}/attributes.adoc"
	echo ":akka-cli-version: 3.0.28" >> "${managed_partials}/attributes.adoc"
...
examples: prepare
	...
	rsync -a akka-javasdk/src/main/java/akka/javasdk/agent/evaluator "${java_managed_examples}/doc-snippets/src/main/java/akka/javasdk/agent/"
