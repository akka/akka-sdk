...
public class DelegativeAgentIntegrationTest extends TestKitSupport {
            ...
            () -> {
              var result =
                  componentClient
                      ...
                      .invoke();
              assertThat(result).isInstanceOf(Delegative.Result.Completed.class);
              var completed = (Delegative.Result.Completed<?>) result;
  ...
  @Test
  public void shouldDelegateToAnotherDelegativeAgentAndCompleteWhenChildReturnsResult() {
            ...
            () -> {
              var result =
                  componentClient
                      ...
                      .method(SimpleOrchestratorAgent::getResult)
                      .invoke();
              assertThat(result).isInstanceOf(Delegative.Result.Failed.class);
              var failed = (Delegative.Result.Failed<?>) result;
