...
/** Simple orchestrator agent for testing the delegative agent feature. */
@Component(id = "simple-orchestrator")
public class SimpleOrchestratorAgent extends Agent implements Delegative<String, String> {
