...
/**
 * Child delegative agent for testing delegation from SimpleOrchestratorAgent to another delegative
 * agent.
 */
@Component(id = "child-orchestrator")
public class ChildOrchestratorAgent extends Agent implements Delegative<String, String> {
