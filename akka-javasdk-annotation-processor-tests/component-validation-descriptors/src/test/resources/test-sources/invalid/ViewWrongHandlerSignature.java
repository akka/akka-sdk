...
@Component(id = "view-wrong-handler-signature")
public class ViewWrongHandlerSignature extends View {
  ...
  public static class Users extends TableUpdater<UserRow> {
    public Effect<UserRow> onEvent(UserEvent event, String extra) {
