...
@Component(id = "view-missing-workflow-transformation")
public class ViewMissingWorkflowTransformationHandler extends View {
  ...
  public static class Rows extends TableUpdater<ViewRow> {
    ...
    // Missing transformation handler: Effect<ViewRow> onChange(String state)
  }
}
