...
@Component(id = "multi-table-view-duplicated-es-handlers")
public class MultiTableViewDuplicatedESHandlers extends View {
  ...
  public static class Counters extends TableUpdater<CounterRow> {
    public Effect<CounterRow> onEvent(SimpleEventSourcedEntity.IncrementCounter event) {
  ...
  public static class Counters2 extends TableUpdater<CounterRow> {
    ...
    public Effect<CounterRow> onEvent2(SimpleEventSourcedEntity.IncrementCounter event) {
      return effects().updateRow(new CounterRow());
    }
  }
}
